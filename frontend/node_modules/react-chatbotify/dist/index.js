...
import xo, { createContext as Iu, useContext as wu, useState as Fe, useEffect as Wt, useRef as Zr, isValidElement as Xu, createElement as Ju, forwardRef as Tn } from "react";
var Du = { exports: {} }, Ei = {};
/**
 * @license React
...
function Ku() {
  if (mu)
    return Ei;
  mu = 1;
  var I = xo, h = Symbol.for("react.element"), S = Symbol.for("react.fragment"), k = Object.prototype.hasOwnProperty, f = I.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, R = { key: !0, ref: !0, __self: !0, __source: !0 };
  function W(U, j, E) {
    var G, P = {}, _ = null, de = null;
    E !== void 0 && (_ = "" + E), j.key !== void 0 && (_ = "" + j.key), j.ref !== void 0 && (de = j.ref);
    for (G in j)
      k.call(j, G) && !R.hasOwnProperty(G) && (P[G] = j[G]);
    if (U && U.defaultProps)
...
function qu() {
  return Eu || (Eu = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function ce(N, Z, q) {
      {
        var fe = b.ReactDebugCurrentFrame, Se = fe.getStackAddendum();
        Se !== "" && (Z += "%s", q = q.concat([Se]));
    ...
    var he = !1, Ae = !1, ye = !1, le = !1, be = !1, we;
    we = Symbol.for("react.module.reference");
    function Ee(N) {
      return !!(typeof N == "string" || typeof N == "function" || N === k || N === R || be || N === f || N === E || N === G || le || N === de || he || Ae || ye || typeof N == "object" && N !== null && (N.$$typeof === _ || N.$$typeof === P || N.$$typeof === W || N.$$typeof === U || N.$$typeof === j || // This needs to include all possible module reference object
      ...
      if (typeof N == "object")
        switch (N.$$typeof) {
          ...
          case P:
            ...
            return fe !== null ? fe : We(N.type) || "Memo";
          case _: {
    ...
    var Le = Object.assign, Be = 0, Xe, tt, rt, gt, bt, je, Ce;
    function vt() {
    }
    ...
    function Dt() {
      {
        if (Be === 0) {
          Xe = console.log, tt = console.info, rt = console.warn, gt = console.error, bt = console.group, je = console.groupCollapsed, Ce = console.groupEnd;
          var N = {
            configurable: !0,
            enumerable: !0,
            value: vt,
    ...
    var He = b.ReactCurrentDispatcher, Ot;
    function Qt(N, Z, q) {
      {
        if (Ot === void 0)
          try {
...
` + Ot + N;
    ...
    function Gt(N, Z) {
      ...
      var ze;
      ze = He.current, He.current = null, Dt();
      try {
        if (Z) {
          var xe = function() {
            throw Error();
        ...
        if (ft && fe && typeof ft.stack == "string") {
          for (var Ie = ft.stack.split(`
`), ct = fe.stack.split(`
`), Ue = Ie.length - 1, Re = ct.length - 1; Ue >= 1 && Re >= 0 && Ie[Ue] !== ct[Re]; )
            Re--;
          for (; Ue >= 1 && Re >= 0; Ue--, Re--)
            if (Ie[Ue] !== ct[Re]) {
              if (Ue !== 1 || Re !== 1)
                do
                  if (Ue--, Re--, Re < 0 || Ie[Ue] !== ct[Re]) {
                    var ot = `
` + Ie[Ue].replace(" at new ", " at ");
                    return N.displayName && ot.includes("<anonymous>") && (ot = ot.replace("<anonymous>", N.displayName)), typeof N == "function" && _e.set(N, ot), ot;
                  }
                while (Ue >= 1 && Re >= 0);
              break;
            }
        ...
        Nt = !1, He.current = ze, qe(), Error.prepareStackTrace = Se;
      }
      var Bt = N ? N.displayName || N.name : "", cr = Bt ? Qt(Bt) : "";
      return typeof N == "function" && _e.set(N, cr), cr;
    }
    function Ge(N, Z, q) {
      return Gt(N, !1);
    }
      ...
      if (typeof N == "object")
        switch (N.$$typeof) {
          case j:
            return Ge(N.render);
          case P:
            return jt(N.type, Z, q);
          case _: {
            var fe = N, Se = fe._payload, ze = fe._init;
            try {
              return jt(ze(Se), Z, q);
            } catch {
            }
    ...
    var mt = Object.prototype.hasOwnProperty, Zt = {}, Tt = b.ReactDebugCurrentFrame;
    function Et(N) {
      if (N) {
        var Z = N._owner, q = jt(N.type, N._source, Z ? Z.type : null);
        Tt.setExtraStackFrame(q);
      } else
        Tt.setExtraStackFrame(null);
    }
    function Xt(N, Z, q, fe, Se) {
      {
        var ze = Function.call.bind(mt);
        for (var xe in N)
          if (ze(N, xe)) {
            var Ie = void 0;
            try {
              if (typeof N[xe] != "function") {
                var ct = Error((fe || "React class") + ": " + q + " type `" + xe + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof N[xe] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw ct.name = "Invariant Violation", ct;
              }
              Ie = N[xe](Z, xe, fe, q, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (Ue) {
              Ie = Ue;
            }
            Ie && !(Ie instanceof Error) && (Et(Se), $("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", fe || "React class", q, xe, typeof Ie), Et(null)), Ie instanceof Error && !(Ie.message in Zt) && (Zt[Ie.message] = !0, Et(Se), $("Failed %s type: %s", q, Ie.message), Et(null));
          }
      }
    }
    ...
    function ar(N) {
      if (nt(N))
        return $("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", at(N)), ir(N);
    }
    var Pt = b.ReactCurrentOwner, Je = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function wr(N, Z) {
      if (typeof N.ref == "string" && Pt.current && Z && Pt.current.stateNode !== Z) {
        var q = We(Pt.current.type);
        Kt[q] || ($('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', We(Pt.current.type), N.ref), Kt[q] = !0);
      }
    }
    function lr(N, Z) {
      {
        var q = function() {
          Jt || (Jt = !0, $("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", Z));
        };
    ...
    var ae = function(N, Z, q, fe, Se, ze, xe) {
      var Ie = {
    ...
    function pe(N, Z, q, fe, Se) {
      {
        var ze, xe = {}, Ie = null, ct = null;
        q !== void 0 && (ar(q), Ie = "" + q), qt(Z) && (ar(Z.key), Ie = "" + Z.key), sr(Z) && (ct = Z.ref, wr(Z, Se));
        for (ze in Z)
          mt.call(Z, ze) && !Je.hasOwnProperty(ze) && (xe[ze] = Z[ze]);
        if (N && N.defaultProps) {
        ...
        if (Ie || ct) {
          ...
          Ie && lr(xe, Re), ct && K(xe, Re);
        }
        return ae(N, Ie, ct, Se, fe, Pt.current, xe);
      }
    }
    var ue = b.ReactCurrentOwner, De = b.ReactDebugCurrentFrame;
    function ve(N) {
      if (N) {
        var Z = N._owner, q = jt(N.type, N._source, Z ? Z.type : null);
        De.setExtraStackFrame(q);
      } else
...
Check the top-level render call using <` + q + ">.");
    ...
    function St(N, Z) {
      {
        ...
        st[q] = !0;
        var fe = "";
        N && N._owner && N._owner !== ue.current && (fe = " It was passed a child from " + We(N._owner.type) + "."), ve(N), $('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', q, fe), ve(null);
      }
    }
    function $e(N, Z) {
      {
    ...
    function Br(N) {
      {
        for (var Z = Object.keys(N.props), q = 0; q < Z.length; q++) {
          ...
          if (fe !== "children" && fe !== "key") {
            ve(N), $("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", fe), ve(null);
            break;
          }
        }
    ...
    function Ur(N, Z, q, fe, Se, ze) {
      {
        ...
        if (!xe) {
          ...
          ct ? Ie += ct : Ie += At();
          var Ue;
          N === null ? Ue = "null" : It(N) ? Ue = "array" : N !== void 0 && N.$$typeof === h ? (Ue = "<" + (We(N.type) || "Unknown") + " />", Ie = " Did you accidentally export a JSX literal instead of a component?") : Ue = typeof N, $("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", Ue, Ie);
        }
        var Re = pe(N, Z, q, Se, ze);
        if (Re == null)
          return Re;
        if (xe) {
          var ot = Z.children;
    ...
    var an = Rr, un = lt;
    Ci.Fragment = k, Ci.jsx = an, Ci.jsxs = un;
  }()), Ci;
}
process.env.NODE_ENV === "production" ? Du.exports = Ku() : Du.exports = qu();
var F = Du.exports;
const Bu = Iu({ botOptions: {}, setBotOptions: () => null }), Vt = () => wu(Bu);
const _u = ({
  ...
  var E, G, P, _, de, ee, re, H, b, $, ce, he;
  const { botOptions: f, setBotOptions: R } = Vt(), W = {
  ...
  return /* @__PURE__ */ F.jsxs("div", { style: W, className: "rcb-chat-header-container", children: [
    ...
    /* @__PURE__ */ F.jsxs("div", { className: "rcb-chat-header", children: [
      !((b = f.notification) != null && b.disabled) && !(($ = f.theme) != null && $.embedded) && /* @__PURE__ */ F.jsx(
        "div",
        {
      ...
      !((ce = f.audio) != null && ce.disabled) && /* @__PURE__ */ F.jsx(
        "div",
        {
          style: U.audioIcon,
          onMouseDown: (Ae) => {
      ...
      !((he = f.theme) != null && he.embedded) && /* @__PURE__ */ F.jsx(
        "div",
        {
...
const $u = ({
  ...
  var de, ee, re;
  const { botOptions: f } = Vt(), [R, W] = Fe(!1), U = {
  ...
  function G(H) {
    if (!I.current)
      return;
    const b = I.current.scrollTop, ce = I.current.scrollHeight - I.current.clientHeight - b, he = 20;
    let Ae = 0;
    function ye() {
      if (!I.current)
        return;
      Ae += he;
      const le = P(Ae, b, ce, H);
      I.current.scrollTop = le, Ae < H ? requestAnimationFrame(ye) : S(!1);
    }
    ye();
  }
  const P = (H, b, $, ce) => (H /= ce / 2, H < 1 ? $ / 2 * H * H + b : (H--, -$ / 2 * (H * (H - 2) - 1) + b)), _ = () => {
    var b;
    return I.current && ((b = f.chatWindow) == null ? void 0 : b.showMessagePrompt) && h && k > 0 ? "visible" : "hidden";
  };
...
const es = ({
  ...
  var he, Ae, ye, le, be, we, Ee, Ye, ke, We;
  const { botOptions: G } = Vt(), { messages: P } = Ru(), _ = {
    ...G == null ? void 0 : G.bodyStyle,
    scrollbarWidth: (he = G.chatWindow) != null && he.showScrollbar ? "auto" : "none"
  }, de = {
    backgroundColor: (Ae = G.theme) == null ? void 0 : Ae.primaryColor,
    color: "#fff",
    maxWidth: (ye = G.userBubble) != null && ye.showAvatar ? "65%" : "70%",
    ...G.userBubbleStyle
  }, ee = (le = G.userBubble) != null && le.animate ? "rcb-user-message-entry" : "", re = {
    backgroundColor: (be = G.theme) == null ? void 0 : be.secondaryColor,
    color: "#fff",
    maxWidth: (we = G.botBubble) != null && we.showAvatar ? "65%" : "70%",
    ...G.botBubbleStyle
  }, H = (Ee = G.botBubble) != null && Ee.animate ? "rcb-bot-message-entry" : "";
  Wt(() => {
    var Le;
    if (I.current) {
      if (S) {
        const { scrollHeight: Be } = I.current, Xe = Be - k;
        I.current.scrollTop = I.current.scrollTop + Xe, R(!1);
        return;
      }
  ...
  }, [(Ye = I.current) == null ? void 0 : Ye.scrollHeight]), Wt(() => {
    W || E(0);
  }, [W]);
  const b = () => {
    var tt;
    if (!I.current)
      return;
    const { scrollTop: Le, clientHeight: Be, scrollHeight: Xe } = I.current;
    U(
      Le + Be < Xe - (((tt = G.chatWindow) == null ? void 0 : tt.messagePromptOffset) || 30)
    ), !W && Le + Be >= Xe - 1 && (I.current.scrollTop = Xe - Be - 1);
  }, $ = (Le) => {
    var Be, Xe, tt;
    return /* @__PURE__ */ F.jsxs(F.Fragment, { children: [
      (Be = G == null ? void 0 : G.userBubble) != null && Be.dangerouslySetInnerHtml ? /* @__PURE__ */ F.jsx(
        "div",
        {
      ...
      ((Xe = G.userBubble) == null ? void 0 : Xe.showAvatar) && /* @__PURE__ */ F.jsx(
        "div",
        {
          style: { backgroundImage: `url(${(tt = G.userBubble) == null ? void 0 : tt.avatar})` },
    ...
    var Be, Xe, tt;
    return /* @__PURE__ */ F.jsxs(F.Fragment, { children: [
      ((Be = G.botBubble) == null ? void 0 : Be.showAvatar) && /* @__PURE__ */ F.jsx(
        "div",
        {
          style: { backgroundImage: `url(${(Xe = G.botBubble) == null ? void 0 : Xe.avatar})` },
          className: "rcb-message-bot-avatar"
        }
      ),
      (tt = G == null ? void 0 : G.botBubble) != null && tt.dangerouslySetInnerHtml ? /* @__PURE__ */ F.jsx(
        "div",
        {
  ...
  return /* @__PURE__ */ F.jsxs(
    "div",
    {
      ...
      onScroll: b,
      children: [
        P.map((Le, Be) => typeof Le.content != "string" ? /* @__PURE__ */ F.jsx("div", { children: Le.content }, Be) : /* @__PURE__ */ F.jsx(
          "div",
          {
            className: Le.sender === "user" ? "rcb-user-message-container" : "rcb-bot-message-container",
            children: Le.sender === "user" ? $(Le) : ce(Le)
          },
          Be
        )),
        h && /* @__PURE__ */ F.jsxs("div", { className: "rcb-bot-message-container", children: [
          ((ke = G.botBubble) == null ? void 0 : ke.showAvatar) && /* @__PURE__ */ F.jsx(
            "div",
            {
              style: { backgroundImage: `url(${(We = G.botBubble) == null ? void 0 : We.avatar})` },
              className: "rcb-message-bot-avatar"
            }
          ),
          /* @__PURE__ */ F.jsx(
...
const ts = ({
  ...
  var E, G, P;
  const { botOptions: h } = Vt(), [S, k] = Fe(!1), f = {
...
const rs = (I, h, S, k, f) => {
  ...
  on.onresult = (E) => {
    ...
    if (f.current) {
      const de = (P = I.chatInput) == null ? void 0 : P.characterLimit, ee = f.current.value + G;
      de != null && de >= 0 && ee.length > de ? f.current.value = ee.slice(0, de) : f.current.value = ee, k(f.current.value.length);
    }
  ...
  var S, k;
  (S = h.voice) != null && S.disabled || !((k = h.chatInput) != null && k.blockSpam) || !on || (I && !Co ? (Co = !0, on.start()) : I || Tu());
}, pu = (I) => {
  I(), Tu();
};
const ns = ({
...
}, Qr = !/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), os = (I) => {
  const h = [];
  let S = "", k = !1;
  for (let f = 0; f < I.length; f++) {
    const R = I[f];
    R === "<" ? k ? (h.push(S), S = R) : (k = !0, S = R) : R === ">" ? (S += R, h.push(S), S = "", k = !1) : k ? S += R : h.push(R);
  }
  return S !== "" && h.push(S), h;
}, is = (I) => {
  if (!I)
    return !1;
  const h = I.getBoundingClientRect(), S = window.innerHeight || document.documentElement.clientHeight, k = window.innerWidth || document.documentElement.clientWidth;
  return h.top >= 0 && h.left >= 0 && h.bottom <= S && h.right <= k;
};
const as = ({
  inputRef: I,
  textAreaDisabled: h,
  ...
  var Ee, Ye, ke, We, Le, Be, Xe, tt, rt, gt, bt;
  const { botOptions: U } = Vt(), [j, E] = Fe(!1), [G, P] = Fe(0), [_, de] = Fe(!1);
  Wt(() => {
    var Ce;
    const je = f();
    je && (W(je, (Ce = I.current) == null ? void 0 : Ce.value), P(0));
  }, [_]);
  const ee = {
    ...
    outline: h ? "" : "none",
    boxShadow: h ? "" : `0 0 5px ${(Ee = U.theme) == null ? void 0 : Ee.primaryColor}`,
    boxSizing: Qr ? "content-box" : "border-box",
    ...U.chatInputAreaStyle,
  ...
  }, ce = h ? (ke = U.chatInput) == null ? void 0 : ke.disabledPlaceholderText : (We = U.chatInput) == null ? void 0 : We.enabledPlaceholderText, he = () => {
    h || E(!0);
  }, Ae = () => {
    E(!1);
  }, ye = (je) => {
    je.key === "Enter" && (je.preventDefault(), be(je));
  }, le = (je) => {
    var Ce;
    if (h && I.current) {
      I.current.value = "";
    ...
    if (I.current) {
      const vt = (Ce = U.chatInput) == null ? void 0 : Ce.characterLimit, Dt = je.target.value.replace(/\n/g, " ");
      vt != null && vt >= 0 && Dt.length > vt ? I.current.value = Dt.slice(0, vt) : I.current.value = Dt, P(I.current.value.length);
    }
  }, be = (je) => {
    var vt;
    je.preventDefault();
    const Ce = f();
    Ce && (W(Ce, (vt = I.current) == null ? void 0 : vt.value), P(0));
  }, we = () => {
    de((je) => !je);
  };
  return /* @__PURE__ */ F.jsxs(
    "div",
    {
      ...
      children: [
        S && ((Le = U.sensitiveInput) != null && Le.maskInTextArea) ? /* @__PURE__ */ F.jsx(
          "input",
          {
            ref: I,
            type: "password",
        ...
        /* @__PURE__ */ F.jsxs("div", { className: "rcb-chat-input-button-container", children: [
          !((Be = U.voice) != null && Be.disabled) && Qr && /* @__PURE__ */ F.jsx(
            ns,
            {
              inputRef: I,
              textAreaDisabled: h,
          ...
          ((Xe = U.chatInput) == null ? void 0 : Xe.showCharacterCount) && ((tt = U.chatInput) == null ? void 0 : tt.characterLimit) != null && ((rt = U.chatInput) == null ? void 0 : rt.characterLimit) > 0 && /* @__PURE__ */ F.jsxs(
            "div",
            {
              className: "rcb-chat-input-char-counter",
              style: G >= ((gt = U.chatInput) == null ? void 0 : gt.characterLimit) ? $ : b,
              children: [
                G,
                "/",
                (bt = U.chatInput) == null ? void 0 : bt.characterLimit
              ]
            }
          )
        ] })
...
const us = ({
  ...
  var G, P, _, de;
  const { botOptions: S } = Vt(), k = Zr(null), f = Zr(null), [R, W] = Fe(!1), U = {
    cursor: `url(${(G = S.theme) == null ? void 0 : G.actionDisabledIcon}), auto`
  };
  Wt(() => {
    const ee = (b) => {
      k.current && !k.current.contains(b.target) && f.current && !f.current.contains(b.target) && W(!1);
    }, re = () => {
      if (k.current && f.current) {
        const b = f.current.getBoundingClientRect(), $ = k.current.offsetHeight, ce = b.top - $ - 8;
        k.current.style.left = `${b.left}px`, k.current.style.top = `${ce}px`;
      }
    }, H = () => {
      re();
    };
  ...
  return /* @__PURE__ */ F.jsxs(F.Fragment, { children: [
    ...
    R && /* @__PURE__ */ F.jsx("div", { className: "rcb-emoji-picker-popup", ref: k, children: (de = (_ = S.emoji) == null ? void 0 : _.list) == null ? void 0 : de.map((ee, re) => /* @__PURE__ */ F.jsx(
      "span",
      {
        className: "rcb-emoji",
...
const ss = ({
  ...
  var de, ee, re, H, b;
  const { botOptions: j } = Vt(), { paths: E } = Na(), [G, P] = Fe(!1);
  Wt(() => {
    const $ = R();
    if (!$)
      return;
    const ce = h[$];
    ce && P(typeof ce.file == "function");
  }, [E]);
  const _ = async ($) => {
    var le, be;
    const ce = $.target.files;
    if (!ce)
      return;
    const he = R();
    if (!he)
    ...
    if (ye != null) {
      ...
      for (let Ee = 0; Ee < ce.length; Ee++)
        we.push(ce[Ee].name);
      await U(he, "📄 " + we.join(", "), (le = j.chatInput) == null ? void 0 : le.sendAttachmentOutput), await ye({
  ...
  return /* @__PURE__ */ F.jsx(F.Fragment, { children: G ? /* @__PURE__ */ F.jsxs("label", { className: "rcb-attach-button-enabled", children: [
    /* @__PURE__ */ F.jsx(
      "input",
      {
    ...
    "label",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ F.jsx(
          ...
          {
            style: {
              backgroundImage: `url(${(b = j.fileAttachment) == null ? void 0 : b.icon})`
            },
...
const ls = ({
  ...
  var G, P, _;
  const { botOptions: E } = Vt();
  return /* @__PURE__ */ F.jsxs("div", { style: E.footerStyle, className: "rcb-chat-footer-container", children: [
    /* @__PURE__ */ F.jsxs("div", { className: "rcb-chat-footer", children: [
      !((G = E.fileAttachment) != null && G.disabled) && /* @__PURE__ */ F.jsx(
        ss,
        {
          inputRef: I,
          flow: h,
      ...
      !((P = E.emoji) != null && P.disabled) && /* @__PURE__ */ F.jsx(us, { inputRef: I, textAreaDisabled: S })
    ] }),
    /* @__PURE__ */ F.jsx("span", { children: (_ = E.footer) == null ? void 0 : _.text })
  ] });
};
const cs = ({
  unreadCount: I
  ...
  var R, W, U, j, E, G;
  const { botOptions: h, setBotOptions: S } = Vt(), k = () => {
    S({ ...h, isOpen: !h.isOpen });
  }, f = {
  ...
  return /* @__PURE__ */ F.jsx(F.Fragment, { children: !((j = h.theme) != null && j.embedded) && /* @__PURE__ */ F.jsx(
    "button",
    {
      ...
      onClick: k,
      children: !((E = h.notification) != null && E.disabled) && ((G = h.notification) == null ? void 0 : G.showCount) && /* @__PURE__ */ F.jsx("span", { style: h.notificationBadgeStyle, className: "rcb-badge", children: I })
    }
  ) });
};
const fs = () => {
  var G, P, _, de, ee;
  const { botOptions: I, setBotOptions: h } = Vt(), [S, k] = Fe(!1), [f, R] = Fe(!1), [W, U] = Fe(0);
  Wt(() => {
    var H, b, $;
    ...
    if (re === "ALWAYS")
      if (Qr) {
        let ce;
        I.isOpen ? ce = (((b = I.chatWindowStyle) == null ? void 0 : b.width) || 375) - ((($ = I.chatButtonStyle) == null ? void 0 : $.width) || 75) : ce = 0, U(ce), k(!0);
      } else
        I.isOpen ? k(!1) : k(!0);
    else
      re === "NEVER" ? k(!1) : re === "START" ? f ? k(!1) : (R(!0), k(!0)) : re === "CLOSE" && k(!I.isOpen);
  }, [I.isOpen]);
  const j = {
...
const ds = ({
  ...
  var j, E, G;
  const { botOptions: S } = Vt(), [k, f] = Fe(!1), R = {
  ...
  return /* @__PURE__ */ F.jsx("div", { className: "rcb-view-history-container", children: /* @__PURE__ */ F.jsx(
    "div",
    {
      onMouseEnter: W,
      onMouseLeave: U,
      style: k ? R : S.chatHistoryButtonStyle,
      onMouseDown: (P) => {
...
const Ms = ({
  ...
  var re, H, b, $, ce, he, Ae, ye, le, be, we;
  const { botOptions: f } = Vt(), { paths: R } = Na(), [W, U] = Fe(/* @__PURE__ */ new Set()), [j, E] = Fe(!1), G = {
    ...
    borderColor: (he = f.theme) == null ? void 0 : he.primaryColor,
  ...
  return /* @__PURE__ */ F.jsxs("div", { className: `rcb-checkbox-container ${(we = f.botBubble) != null && we.showAvatar ? "rcb-checkbox-offset" : ""}`, children: [
    I.items.map((Ee) => /* @__PURE__ */ F.jsx(
      "div",
      {
        onMouseDown: (Ye) => {
          Ye.preventDefault(), ee(Ee);
        },
        style: G,
        ...
        children: /* @__PURE__ */ F.jsxs("div", { className: "rcb-checkbox-row", children: [
          ...
          /* @__PURE__ */ F.jsx("div", { className: "rcb-checkbox-label", children: Ee })
        ] })
      },
      Ee
    )),
    /* @__PURE__ */ F.jsx(
      "button",
      {
        ...
        onMouseDown: (Ee) => {
          ...
          E(!0), k(S, Ye, (ke = f.chatInput) == null ? void 0 : ke.sendCheckboxOutput);
        }
      }
    )
  ] });
  ...
  if (!S)
    return;
  const k = S(h);
  return k instanceof Promise ? await k : k;
}, ys = async (I, h) => {
  const S = I.message;
  if (!S)
    return;
  ...
  let k = S(h);
  k instanceof Promise && (k = await k), k && k.trim() !== "" && await h.injectMessage(k);
};
const ps = ({
  options: I,
  path: h,
  ...
  var de, ee, re, H, b, $;
  const { botOptions: k } = Vt(), { paths: f } = Na(), [R, W] = Fe([]), [U, j] = Fe(!1), E = {
    cursor: U ? `url(${(de = k.theme) == null ? void 0 : de.actionDisabledIcon}), auto` : "pointer",
    color: (ee = k.theme) == null ? void 0 : ee.primaryColor,
    borderColor: (re = k.theme) == null ? void 0 : re.primaryColor,
    backgroundColor: "#fff",
    ...k.botOptionStyle
  }, G = {
    color: "#fff",
    borderColor: (H = k.theme) == null ? void 0 : H.primaryColor,
    backgroundColor: (b = k.theme) == null ? void 0 : b.primaryColor,
    ...k.botOptionHoveredStyle
  };
  Wt(() => {
  ...
  return /* @__PURE__ */ F.jsx("div", { className: `rcb-options-container ${($ = k.botBubble) != null && $.showAvatar ? "rcb-options-offset" : ""}`, children: I.map((ce, he) => {
    const Ae = R[he] && !U;
    return /* @__PURE__ */ F.jsx(
      "div",
      {
        ...
        onMouseDown: (ye) => {
          var le;
          ye.preventDefault(), !U && (j(!0), S(h, ce, (le = k.chatInput) == null ? void 0 : le.sendOptionOutput));
        },
        children: ce
      },
      ce
  ...
  if (!f)
    return;
  S(/* @__PURE__ */ F.jsx(ps, { options: f, path: h, handleActionInput: k }));
}, Ds = async (I, h, S) => {
  const k = I.path;
  if (!k)
    return !1;
  ...
  let U;
  if (typeof W == "function" ? (U = W(S), U instanceof Promise && (U = await U)) : U = W, !U || U instanceof Promise || U.duration == null || typeof U.duration != "number")
    return;
  ...
  for (const E of Object.keys(j))
    switch (E) {
      ...
      case "render":
        ...
        break;
      case "chatDisabled":
        j.chatDisabled && k(j.chatDisabled);
        break;
      case "isSensitive":
  ...
  return R.includes("path") ? await Ds(f, S, k) : !1;
};
var xA = {}, mA = {};
/**
 * @license React
...
function Is() {
  ...
  var S = Object.prototype.hasOwnProperty, k = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/, f = {}, R = {};
  function W(A) {
    return S.call(R, A) ? !0 : S.call(f, A) ? !1 : k.test(A) ? R[A] = !0 : (f[A] = !0, !1);
  }
  function U(A, s, g, p, x, m, B) {
    this.acceptsBooleans = s === 2 || s === 3 || s === 4, this.attributeName = p, this.attributeNamespace = x, this.mustUseProperty = g, this.propertyName = A, this.type = s, this.sanitizeURL = m, this.removeEmptyString = B;
  }
  var j = {};
      ...
      if (S.call(g, p)) {
        ...
        if (x != null && typeof x != "boolean" && x !== "") {
          if (p.indexOf("--") === 0) {
            ...
            m = p;
            var B = he.get(m);
            B !== void 0 || (B = ee(m.replace(re, "-$1").toLowerCase().replace(H, "-ms-")), he.set(m, B)), m = B, x = typeof x == "number" ? x === 0 || S.call(P, p) ? "" + x : x + "px" : ee(("" + x).trim());
          }
          s ? (s = !1, A.push(' style="', m, ":", x)) : A.push(";", m, ":", x);
        }
      }
    s || A.push('"');
  }
  ...
  function we(A, s, g, p) {
    ...
    return A.push(">"), le(A, x, g), typeof g == "string" ? (A.push(ee(g)), null) : g;
  }
  var Ee = /^[a-zA-Z][a-zA-Z:_\.\-\d]*$/, Ye = /* @__PURE__ */ new Map();
  function ke(A) {
    var s = Ye.get(A);
    if (s === void 0) {
      if (!Ee.test(A))
  ...
  function We(A, s, g, p, x) {
    switch (s) {
      case "select":
        ...
        return A.push(">"), le(A, B, m), m;
      case "option":
        B = x.selectedValue, A.push(ke("option"));
        var oe = X = null, Me = null, se = null;
        for (m in g)
          if (S.call(g, m)) {
            var Qe = g[m];
            if (Qe != null)
...
`), m !== null && A.push(ee("" + m)), null;
      case "input":
        A.push(ke("input")), oe = se = X = m = null;
        for (B in g)
          if (S.call(g, B) && (Me = g[B], Me != null))
            switch (B) {
              case "children":
              case "dangerouslySetInnerHTML":
        ...
        return se !== null ? ye(A, p, "checked", se) : oe !== null && ye(A, p, "checked", oe), m !== null ? ye(A, p, "value", m) : X !== null && ye(A, p, "value", X), A.push("/>"), null;
      case "menuitem":
        A.push(ke("menuitem"));
        for (var Rt in g)
          if (S.call(g, Rt) && (m = g[Rt], m != null))
            switch (Rt) {
              case "children":
              case "dangerouslySetInnerHTML":
                throw Error(h(400));
...
`), m;
  ...
  var tt = /[<\u2028\u2029]/g;
  function rt(A) {
    return JSON.stringify(A).replace(tt, function(s) {
      switch (s) {
        case "<":
          return "\\u003c";
        case "\u2028":
  ...
  var je = Object.assign, Ce = Symbol.for("react.element"), vt = Symbol.for("react.portal"), Dt = Symbol.for("react.fragment"), qe = Symbol.for("react.strict_mode"), He = Symbol.for("react.profiler"), Ot = Symbol.for("react.provider"), Qt = Symbol.for("react.context"), Nt = Symbol.for("react.forward_ref"), _e = Symbol.for("react.suspense"), ht = Symbol.for("react.suspense_list"), Gt = Symbol.for("react.memo"), Ge = Symbol.for("react.lazy"), yt = Symbol.for("react.scope"), jt = Symbol.for("react.debug_trace_mode"), mt = Symbol.for("react.legacy_hidden"), Zt = Symbol.for("react.default_value"), Tt = Symbol.iterator;
  function Et(A) {
    if (A == null)
      return null;
    ...
    if (typeof A == "object")
      switch (A.$$typeof) {
        ...
        case Gt:
          return s = A.displayName || null, s !== null ? s : Et(A.type) || "Memo";
        case Ge:
  ...
  function ar(A, s) {
    if (A.context._currentValue2 = A.parentValue, A = A.parent, A === null)
      throw Error(h(402));
    A.depth === s.depth ? at(A, s) : ar(A, s);
  }
  function Pt(A, s) {
    var g = s.parent;
    if (g === null)
      throw Error(h(402));
    A.depth === g.depth ? at(A, g) : Pt(A, g), s.context._currentValue2 = s.value;
  }
  function Je(A) {
    var s = It;
    s !== A && (s === null ? ir(A) : A === null ? nt(s) : s.depth === A.depth ? at(s, A) : s.depth > A.depth ? ar(s, A) : Pt(s, A), It = A);
  }
  ...
  function ur(A, s, g, p) {
    ...
    A.updater = Jt, A.props = g, A.state = x;
    var m = { queue: [], replace: !1 };
    A._reactInternals = m;
    var B = s.contextType;
    if (A.context = typeof B == "object" && B !== null ? B._currentValue2 : p, B = s.getDerivedStateFromProps, typeof B == "function" && (B = B(g, x), x = B == null ? x : je({}, x, B), A.state = x), typeof s.getDerivedStateFromProps != "function" && typeof A.getSnapshotBeforeUpdate != "function" && (typeof A.UNSAFE_componentWillMount == "function" || typeof A.componentWillMount == "function"))
      if (s = A.state, typeof A.componentWillMount == "function" && A.componentWillMount(), typeof A.UNSAFE_componentWillMount == "function" && A.UNSAFE_componentWillMount(), s !== A.state && Jt.enqueueReplaceState(A, A.state, null), m.queue !== null && 0 < m.queue.length)
        if (s = m.queue, B = m.replace, m.queue = null, m.replace = !1, B && s.length === 1)
          A.state = s[0];
        else {
          for (m = B ? s[0] : A.state, x = !0, B = B ? 1 : 0; B < s.length; B++) {
            var X = s[B];
            X = typeof X == "function" ? X.call(A, m, g, p) : X, X != null && (x ? (x = !1, m = je({}, m, X)) : je(m, X));
          }
          A.state = m;
        }
      else
  ...
  function sr(A, s, g) {
    ...
    if (30 < m) {
      var B = x - x % 5;
      return m = (p & (1 << B) - 1).toString(32), p >>= B, x -= B, { id: 1 << 32 - qt(s) + x | g << x | p, overflow: m + A };
    }
    return { id: 1 << m | g << x | p, overflow: A };
  }
  var qt = Math.clz32 ? Math.clz32 : K, wr = Math.log, lr = Math.LN2;
  function K(A) {
  ...
  var pe = typeof Object.is == "function" ? Object.is : ae, ue = null, De = null, ve = null, ne = null, Oe = !1, At = !1, ut = 0, st = null, Lt = 0;
  function St() {
    if (ue === null)
      throw Error(h(321));
    return ue;
  ...
  function Pr() {
    return ne === null ? ve === null ? (Oe = !1, ve = ne = $e()) : (Oe = !0, ne = ve) : ne.next === null ? (Oe = !1, ne = ne.next = $e()) : (Oe = !0, ne = ne.next), ne;
  }
  function Br() {
    De = ue = null, At = !1, ve = null, Lt = 0, ne = st = null;
  }
  function Ur(A, s) {
  ...
  function lt(A, s, g) {
    if (ue = St(), ne = Pr(), Oe) {
      var p = ne.queue;
      if (s = p.dispatch, st !== null && (g = st.get(p), g !== void 0)) {
        st.delete(p), p = ne.memoizedState;
        do
    ...
    return A = A === Ur ? typeof s == "function" ? s() : s : g !== void 0 ? g(s) : s, ne.memoizedState = A, A = ne.queue = { last: null, dispatch: null }, A = A.dispatch = an.bind(null, ue, A), [ne.memoizedState, A];
  }
  function Rr(A, s) {
    if (ue = St(), ne = Pr(), s = s === void 0 ? null : s, ne !== null) {
  ...
  function an(A, s, g) {
    if (25 <= Lt)
      throw Error(h(301));
    if (A === ue)
      if (At = !0, A = { action: g, next: null }, st === null && (st = /* @__PURE__ */ new Map()), g = st.get(s), g === void 0)
        st.set(s, A);
      else {
        for (s = g; s.next !== null; )
          s = s.next;
  ...
  var Z = { readContext: function(A) {
    ...
    var A = De.treeContext, s = A.overflow;
    A = A.id, A = (A & ~(1 << 32 - qt(A) - 1)).toString(32) + s;
    var g = q;
    if (g === null)
      throw Error(h(404));
    return s = ut++, A = ":" + g.idPrefix + "R" + A, 0 < s && (A += "H" + s.toString(32)), A + ":";
  }, useMutableSource: function(A, s) {
    return St(), s(A._source);
  }, useSyncExternalStore: function(A, s, g) {
    if (g === void 0)
      throw Error(h(407));
    return g();
  } }, q = null, fe = I.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher;
  function Se(A) {
    return console.error(A), null;
  }
  function ze() {
  }
  function xe(A, s, g, p, x, m, B, X, oe) {
    var Me = [], se = /* @__PURE__ */ new Set();
    return s = { destination: null, responseState: s, progressiveChunkSize: p === void 0 ? 12800 : p, status: 0, fatalError: null, nextSegmentId: 0, allPendingTasks: 0, pendingRootTasks: 0, completedRootSegment: null, abortableTasks: se, pingedTasks: Me, clientRenderedBoundaries: [], completedBoundaries: [], partialBoundaries: [], onError: x === void 0 ? Se : x, onAllReady: m === void 0 ? ze : m, onShellReady: B === void 0 ? ze : B, onShellError: X === void 0 ? ze : X, onFatalError: oe === void 0 ? ze : oe }, g = ct(s, 0, null, g, !1, !1), g.parentFlushed = !0, A = Ie(s, A, null, g, se, Xt, null, Kt), Me.push(A), s;
  }
  function Ie(A, s, g, p, x, m, B, X) {
    A.allPendingTasks++, g === null ? A.pendingRootTasks++ : g.pendingTasks++;
    var oe = { node: s, ping: function() {
      var Me = A.pingedTasks;
      Me.push(oe), Me.length === 1 && Ut(A);
    }, blockedBoundary: g, blockedSegment: p, abortSet: x, legacyContext: m, context: B, treeContext: X };
    return x.add(oe), oe;
  }
  function ct(A, s, g, p, x, m) {
    return { status: 0, id: -1, index: s, parentFlushed: !1, chunks: [], children: [], formatContext: p, boundary: g, lastPushedText: x, textEmbedded: m };
  }
  function Ue(A, s) {
  ...
  function ot(A, s, g, p, x) {
    for (ue = {}, De = s, ut = 0, A = g(p, x); At; )
      At = !1, ut = 0, Lt += 1, ne = null, A = g(p, x);
    return Br(), A;
  }
  function Bt(A, s, g, p) {
    var x = g.render(), m = p.childContextTypes;
    if (m != null) {
      ...
      if (typeof g.getChildContext != "function")
        ...
        for (var X in g)
          if (!(X in m))
            throw Error(h(108, Et(p) || "Unknown", X));
        p = je({}, B, g);
      }
      s.legacyContext = p, dt(A, s, x), s.legacyContext = B;
    } else
      dt(A, s, x);
  }
  function cr(A, s) {
    if (A && A.defaultProps) {
      s = je({}, s), A = A.defaultProps;
      for (var g in A)
        s[g] === void 0 && (s[g] = A[g]);
      return s;
    }
  ...
  function ft(A, s, g, p, x) {
    if (typeof g == "function")
      if (g.prototype && g.prototype.isReactComponent) {
        x = Ir(g, s.legacyContext);
        var m = g.contextType;
        m = new g(p, typeof m == "object" && m !== null ? m._currentValue2 : x), ur(m, g, p, x), Bt(A, s, m, g);
      } else {
        m = Ir(g, s.legacyContext), x = ot(A, s, g, p, m);
        var B = ut !== 0;
        if (typeof x == "object" && x !== null && typeof x.render == "function" && x.$$typeof === void 0)
          ur(x, g, p, m), Bt(A, s, x, g);
        else if (B) {
      ...
      switch (x = s.blockedSegment, m = We(x.chunks, g, p, A.responseState, x.formatContext), x.lastPushedText = !1, B = x.formatContext, x.formatContext = ce(B, g, p), _t(A, s, m), x.formatContext = B, g) {
        case "area":
        case "base":
        case "br":
        case "col":
      ...
      switch (g) {
        ...
        case _e:
          e: {
            g = s.blockedBoundary, x = s.blockedSegment, m = p.fallback, p = p.children, B = /* @__PURE__ */ new Set();
            var X = { id: null, rootSegmentID: -1, parentFlushed: !1, pendingTasks: 0, forceClientRender: !1, completedSegments: [], byteSize: 0, fallbackAbortableTasks: B, errorDigest: null }, oe = ct(A, x.chunks.length, X, x.formatContext, !1, !1);
            x.children.push(oe), x.lastPushedText = !1;
            var Me = ct(A, 0, null, x.formatContext, !1, !1);
            ...
            try {
              if (_t(
                ...
                s,
                p
              ), A.responseState.generateStaticMarkup || Me.lastPushedText && Me.textEmbedded && Me.chunks.push("<!-- -->"), Me.status = 1, dr(X, Me), X.pendingTasks === 0)
                break e;
            } catch (se) {
              Me.status = 4, X.forceClientRender = !0, X.errorDigest = Ue(A, se);
            } finally {
              s.blockedBoundary = g, s.blockedSegment = x;
            }
            s = Ie(A, m, g, oe, B, s.legacyContext, s.context, s.treeContext), A.pingedTasks.push(s);
          }
          return;
      }
      if (typeof g == "object" && g !== null)
        switch (g.$$typeof) {
          case Nt:
            ...
            return;
          case Gt:
            g = g.type, p = cr(g, p), ft(A, s, g, p, x);
            return;
          case Ot:
            if (x = p.children, g = g._context, p = p.value, m = g._currentValue2, g._currentValue2 = p, B = It, It = p = { parent: B, depth: B === null ? 0 : B.depth + 1, context: g, parentValue: m, value: p }, s.context = p, dt(A, s, x), A = It, A === null)
              throw Error(h(403));
            p = A.parentValue, A.context._currentValue2 = p === Zt ? A.context._defaultValue : p, A = It = A.parent, s.context = A;
            return;
          case Qt:
            p = p.children, p = p(g._currentValue2), dt(A, s, p);
            return;
          case Ge:
            x = g._init, g = x(g._payload), p = cr(g, p), ft(
              A,
              s,
              g,
              p,
  ...
  function dt(A, s, g) {
    if (s.node = g, typeof g == "object" && g !== null) {
      ...
      if (g === null || typeof g != "object" ? p = null : (p = Tt && g[Tt] || g["@@iterator"], p = typeof p == "function" ? p : null), p && (p = p.call(g))) {
        if (g = p.next(), !g.done) {
          var x = [];
          do
    ...
    typeof g == "string" ? (p = s.blockedSegment, p.lastPushedText = bt(s.blockedSegment.chunks, g, A.responseState, p.lastPushedText)) : typeof g == "number" && (p = s.blockedSegment, p.lastPushedText = bt(s.blockedSegment.chunks, "" + g, A.responseState, p.lastPushedText));
  }
  function fr(A, s, g) {
    for (var p = g.length, x = 0; x < p; x++) {
      var m = s.treeContext;
      s.treeContext = sr(m, p, x);
      try {
        _t(A, s, g[x]);
      } finally {
        s.treeContext = m;
  ...
  function _t(A, s, g) {
    var p = s.blockedSegment.formatContext, x = s.legacyContext, m = s.context;
    try {
      return dt(A, s, g);
    } catch (oe) {
      if (Br(), typeof oe == "object" && oe !== null && typeof oe.then == "function") {
        g = oe;
        var B = s.blockedSegment, X = ct(A, B.chunks.length, null, B.formatContext, B.lastPushedText, !0);
        B.children.push(X), B.lastPushedText = !1, A = Ie(A, s.node, s.blockedBoundary, X, s.abortSet, s.legacyContext, s.context, s.treeContext).ping, g.then(A, A), s.blockedSegment.formatContext = p, s.legacyContext = x, s.context = m, Je(m);
      } else
        throw s.blockedSegment.formatContext = p, s.legacyContext = x, s.context = m, Je(m), oe;
    }
  }
  function wt(A) {
  ...
  function Mr(A, s, g) {
    if (s === null) {
      ...
      s.pendingTasks--, s.forceClientRender || (s.pendingTasks === 0 ? (g.parentFlushed && g.status === 1 && dr(s, g), s.parentFlushed && A.completedBoundaries.push(s), s.fallbackAbortableTasks.forEach(wt, A), s.fallbackAbortableTasks.clear()) : g.parentFlushed && g.status === 1 && (dr(s, g), s.completedSegments.length === 1 && s.parentFlushed && A.partialBoundaries.push(s)));
    A.allPendingTasks--, A.allPendingTasks === 0 && (A = A.onAllReady, A());
  }
  function Ut(A) {
    if (A.status !== 2) {
      var s = It, g = fe.current;
      fe.current = Z;
      var p = q;
      q = A.responseState;
      try {
        var x = A.pingedTasks, m;
        for (m = 0; m < x.length; m++) {
          var B = x[m], X = A, oe = B.blockedSegment;
          if (oe.status === 0) {
            Je(B.context);
            try {
              dt(X, B, B.node), X.responseState.generateStaticMarkup || oe.lastPushedText && oe.textEmbedded && oe.chunks.push("<!-- -->"), B.abortSet.delete(B), oe.status = 1, Mr(X, B.blockedBoundary, oe);
            } catch (xt) {
              if (Br(), typeof xt == "object" && xt !== null && typeof xt.then == "function") {
                var Me = B.ping;
                xt.then(Me, Me);
              } else {
                B.abortSet.delete(B), oe.status = 4;
                var se = B.blockedBoundary, Qe = xt, Rt = Ue(X, Qe);
                if (se === null ? Re(X, Qe) : (se.pendingTasks--, se.forceClientRender || (se.forceClientRender = !0, se.errorDigest = Rt, se.parentFlushed && X.clientRenderedBoundaries.push(se))), X.allPendingTasks--, X.allPendingTasks === 0) {
                  var Ct = X.onAllReady;
                  Ct();
                }
              }
        ...
        x.splice(0, m), A.destination !== null && Sr(A, A.destination);
      } catch (xt) {
        Ue(A, xt), Re(A, xt);
      } finally {
        q = p, fe.current = g, g === Z && Je(s);
      }
    }
  }
  function Dr(A, s, g) {
    switch (g.parentFlushed = !0, g.status) {
      ...
      case 1:
        ...
        for (var B = 0; B < g.length; B++) {
          for (x = g[B]; m < x.index; m++)
            s.push(p[m]);
          x = Tr(A, s, x);
        }
        for (; m < p.length - 1; m++)
          s.push(p[m]);
        return m < p.length && (x = s.push(p[m])), x;
      default:
        throw Error(h(390));
    }
  }
  function Tr(A, s, g) {
    ...
    if (p.parentFlushed = !0, p.forceClientRender)
      return A.responseState.generateStaticMarkup || (p = p.errorDigest, s.push("<!--$!-->"), s.push("<template"), p && (s.push(' data-dgst="'), p = ee(p), s.push(p), s.push('"')), s.push("></template>")), Dr(A, s, g), A = A.responseState.generateStaticMarkup ? !0 : s.push("<!--/$-->"), A;
    if (0 < p.pendingTasks) {
      p.rootSegmentID = A.nextSegmentId++, 0 < p.completedSegments.length && A.partialBoundaries.push(p);
      var x = A.responseState, m = x.nextSuspenseID++;
      return x = x.boundaryPrefix + m.toString(16), p = p.id = x, Le(s, A.responseState, p), Dr(A, s, g), s.push("<!--/$-->");
    }
  ...
  function sn(A, s, g) {
    return Be(s, A.responseState, g.formatContext, g.id), Tr(A, s, g), Xe(s, g.formatContext);
  }
  function ln(A, s, g) {
  ...
  function Sr(A, s) {
    try {
      ...
      var x = A.clientRenderedBoundaries, m;
      for (m = 0; m < x.length; m++) {
        var B = x[m];
        p = s;
        var X = A.responseState, oe = B.id, Me = B.errorDigest, se = B.errorMessage, Qe = B.errorComponentStack;
        ...
        if (!p.push(")<\/script>")) {
          A.destination = null, m++, x.splice(0, m);
          return;
        }
      }
      x.splice(0, m);
  ...
  function qr(A, s, g, p) {
    var x = !1, m = null, B = "", X = { push: function(Me) {
      return Me !== null && (B += Me), !0;
    }, destroy: function(Me) {
      x = !0, m = Me;
    } }, oe = !1;
    if (A = xe(A, gt(g, s ? s.identifierPrefix : void 0), { insertionMode: 1, selectedValue: null }, 1 / 0, Kr, void 0, function() {
      oe = !0;
...
function ws() {
  ...
  function f(o, l) {
    if (l.length !== 0)
      if (512 < l.length)
        0 < k && (o.enqueue(new Uint8Array(S.buffer, 0, k)), S = new Uint8Array(512), k = 0), o.enqueue(l);
      else {
        var M = S.length - k;
        M < l.length && (M === 0 ? o.enqueue(S) : (S.set(l.subarray(0, M), k), o.enqueue(S), l = l.subarray(M)), S = new Uint8Array(512), k = 0), S.set(l, k), k += l.length;
      }
  }
  function R(o, l) {
    return f(o, l), !0;
  ...
  function W(o) {
    S && 0 < k && (o.enqueue(new Uint8Array(S.buffer, 0, k)), S = null, k = 0);
  }
  ...
  Object.keys(he).forEach(function(o) {
    Ae.forEach(function(l) {
      l = l + o.charAt(0).toUpperCase() + o.substring(1), he[l] = he[o];
    });
  });
  var ye = /["'&<>]/;
  function le(o) {
  ...
  var be = /([A-Z])/g, we = /^ms-/, Ee = Array.isArray, Ye = E("<script>"), ke = E("<\/script>"), We = E('<script src="'), Le = E('<script type="module" src="'), Be = E('" async=""><\/script>'), Xe = /(<\/|<)(s)(cript)/gi;
  function tt(o, l, M, v) {
    return "" + l + (M === "s" ? "\\u0073" : "\\u0053") + v;
  }
  function rt(o, l, M, v, z) {
    o = o === void 0 ? "" : o, l = l === void 0 ? Ye : E('<script nonce="' + le(l) + '">');
    var C = [];
    if (M !== void 0 && C.push(l, j(("" + M).replace(Xe, tt)), ke), v !== void 0)
      for (M = 0; M < v.length; M++)
        C.push(We, j(le(v[M])), Be);
    if (z !== void 0)
      for (v = 0; v < z.length; v++)
        C.push(Le, j(le(z[v])), Be);
  ...
  var Ce = E("<!-- -->");
  function vt(o, l, M, v) {
    return l === "" ? v : (v && o.push(Ce), o.push(j(le(l))), !0);
  }
  var Dt = /* @__PURE__ */ new Map(), qe = E(' style="'), He = E(":"), Ot = E(";");
  function Qt(o, l, M) {
    if (typeof M != "object")
      throw Error(h(62));
    l = !0;
      ...
      if (P.call(M, v)) {
        ...
        if (z != null && typeof z != "boolean" && z !== "") {
          if (v.indexOf("--") === 0) {
            ...
            C = v;
            var Y = Dt.get(C);
            Y !== void 0 || (Y = E(le(C.replace(be, "-$1").toLowerCase().replace(we, "-ms-"))), Dt.set(C, Y)), C = Y, z = typeof z == "number" ? z === 0 || P.call(he, v) ? j("" + z) : j(z + "px") : j(le(("" + z).trim()));
          }
          l ? (l = !1, o.push(qe, C, He, z)) : o.push(Ot, C, He, z);
        }
      }
    l || o.push(ht);
  }
  var Nt = E(" "), _e = E('="'), ht = E('"'), Gt = E('=""');
  function Ge(o, l, M, v) {
    switch (M) {
      case "style":
        Qt(o, l, v);
      ...
      if (l = b.hasOwnProperty(M) ? b[M] : null, l !== null) {
        ...
        switch (M = j(l.attributeName), l.type) {
          case 3:
            ...
            break;
          case 4:
            v === !0 ? o.push(Nt, M, Gt) : v !== !1 && o.push(Nt, M, _e, j(le(v)), ht);
            break;
          case 5:
            isNaN(v) || o.push(Nt, M, _e, j(le(v)), ht);
            break;
          case 6:
            !isNaN(v) && 1 <= v && o.push(Nt, M, _e, j(le(v)), ht);
            break;
          default:
            l.sanitizeURL && (v = "" + v), o.push(Nt, M, _e, j(le(v)), ht);
        }
      } else if (re(M)) {
        switch (typeof v) {
          case "function":
  ...
  function Et(o, l, M, v) {
    ...
    return o.push(yt), mt(o, z, M), typeof M == "string" ? (o.push(j(le(M))), null) : M;
  }
  var Xt = E(`
`), Ir = /^[a-zA-Z][a-zA-Z:_\.\-\d]*$/, It = /* @__PURE__ */ new Map();
  ...
  var nt = E("<!DOCTYPE html>");
  function ir(o, l, M, v, z) {
    switch (l) {
      case "select":
        o.push(at("select"));
        var C = null, Y = null;
        ...
        return o.push(yt), mt(o, Y, C), C;
      case "option":
        Y = z.selectedValue, o.push(at("option"));
        var ge = J = null, me = null, Te = null;
        for (C in M)
          if (P.call(M, C)) {
            var Ke = M[C];
            if (Ke != null)
        ...
        if (Y != null)
          ...
          me && o.push(Tt);
        return o.push(yt), mt(o, Te, J), J;
      case "textarea":
        o.push(at("textarea")), Te = Y = C = null;
        for (J in M)
        ...
        if (C === null && Y !== null && (C = Y), o.push(yt), Te != null) {
          if (C != null)
            throw Error(h(92));
          if (Ee(Te) && 1 < Te.length)
            throw Error(h(93));
          C = "" + Te;
        }
        return typeof C == "string" && C[0] === `
` && o.push(Xt), C !== null && o.push(j(le("" + C))), null;
      case "input":
        o.push(at("input")), ge = Te = J = C = null;
        for (Y in M)
          if (P.call(M, Y) && (me = M[Y], me != null))
            switch (Y) {
              case "children":
              case "dangerouslySetInnerHTML":
                throw Error(h(399, "input"));
        ...
        return Te !== null ? Ge(
          ...
          "checked",
          Te
        ) : ge !== null && Ge(o, v, "checked", ge), C !== null ? Ge(o, v, "value", C) : J !== null && Ge(o, v, "value", J), o.push(jt), null;
      case "menuitem":
        o.push(at("menuitem"));
        for (var Ft in M)
          if (P.call(M, Ft) && (C = M[Ft], C != null))
            switch (Ft) {
              case "children":
              case "dangerouslySetInnerHTML":
                throw Error(h(400));
      ...
      case "title":
        o.push(at("title")), C = null;
        for (Ke in M)
          if (P.call(M, Ke) && (Y = M[Ke], Y != null))
            switch (Ke) {
              case "children":
                C = Y;
                break;
...
` && o.push(Xt), C;
      ...
      case "missing-glyph":
        return Et(o, M, l, v);
      case "html":
        return z.insertionMode === 0 && o.push(nt), Et(o, M, l, v);
      default:
          ...
          if (P.call(M, me) && (J = M[me], J != null))
            switch (me) {
              ...
              case "suppressHydrationWarning":
                break;
              default:
                re(me) && typeof J != "function" && typeof J != "symbol" && o.push(Nt, j(me), _e, j(le(J)), ht);
            }
        return o.push(yt), mt(o, Y, C), C;
    }
  }
  var ar = E("</"), Pt = E(">"), Je = E('<template id="'), Jt = E('"></template>'), ur = E("<!--$-->"), Kt = E('<!--$?--><template id="'), sr = E('"></template>'), qt = E("<!--$!-->"), wr = E("<!--/$-->"), lr = E("<template"), K = E('"'), ae = E(' data-dgst="');
  ...
  var De = E('<div hidden id="'), ve = E('">'), ne = E("</div>"), Oe = E('<svg aria-hidden="true" style="display:none" id="'), At = E('">'), ut = E("</svg>"), st = E('<math aria-hidden="true" style="display:none" id="'), Lt = E('">'), St = E("</math>"), $e = E('<table hidden id="'), Pr = E('">'), Br = E("</table>"), Ur = E('<table hidden><tbody id="'), lt = E('">'), Rr = E("</tbody></table>"), an = E('<table hidden><tr id="'), un = E('">'), N = E("</tr></table>"), Z = E('<table hidden><colgroup id="'), q = E('">'), fe = E("</colgroup></table>");
  function Se(o, l, M, v) {
    switch (M.insertionMode) {
      case 0:
      case 1:
        return f(o, De), f(o, l.segmentPrefix), f(o, j(v.toString(16))), R(o, ve);
      case 2:
        return f(o, Oe), f(o, l.segmentPrefix), f(o, j(v.toString(16))), R(o, At);
      case 3:
        return f(o, st), f(o, l.segmentPrefix), f(o, j(v.toString(16))), R(o, Lt);
      case 4:
        return f(o, $e), f(o, l.segmentPrefix), f(o, j(v.toString(16))), R(o, Pr);
      case 5:
  ...
  var xe = E('function $RS(a,b){a=document.getElementById(a);b=document.getElementById(b);for(a.parentNode.removeChild(a);a.firstChild;)b.parentNode.insertBefore(a.firstChild,b);b.parentNode.removeChild(b)};$RS("'), Ie = E('$RS("'), ct = E('","'), Ue = E('")<\/script>'), Re = E('function $RC(a,b){a=document.getElementById(a);b=document.getElementById(b);b.parentNode.removeChild(b);if(a){a=a.previousSibling;var f=a.parentNode,c=a.nextSibling,e=0;do{if(c&&8===c.nodeType){var d=c.data;if("/$"===d)if(0===e)break;else e--;else"$"!==d&&"$?"!==d&&"$!"!==d||e++}d=c.nextSibling;f.removeChild(c);c=d}while(c);for(;b.firstChild;)f.insertBefore(b.firstChild,c);a.data="$";a._reactRetry&&a._reactRetry()}};$RC("'), ot = E('$RC("'), Bt = E('","'), cr = E('")<\/script>'), ft = E('function $RX(b,c,d,e){var a=document.getElementById(b);a&&(b=a.previousSibling,b.data="$!",a=a.dataset,c&&(a.dgst=c),d&&(a.msg=d),e&&(a.stck=e),b._reactRetry&&b._reactRetry())};$RX("'), dt = E('$RX("'), fr = E('"'), _t = E(")<\/script>"), wt = E(","), Xr = /[<\u2028\u2029]/g;
  function dr(o) {
  ...
  function Rt(o) {
    o.context._currentValue = o.parentValue, o = o.parent, o !== null && Rt(o);
  }
  function Ct(o) {
    var l = o.parent;
    l !== null && Ct(l), o.context._currentValue = o.value;
  }
  function xt(o, l) {
    if (o.context._currentValue = o.parentValue, o = o.parent, o === null)
      throw Error(h(402));
    o.depth === l.depth ? Qe(o, l) : xt(o, l);
  }
  function Lr(o, l) {
    var M = l.parent;
    if (M === null)
      throw Error(h(402));
    o.depth === M.depth ? Qe(o, M) : Lr(o, M), l.context._currentValue = l.value;
  }
  function $t(o) {
    var l = se;
    l !== o && (l === null ? Ct(o) : o === null ? Rt(l) : l.depth === o.depth ? Qe(l, o) : l.depth > o.depth ? xt(l, o) : Lr(l, o), se = o);
  }
      ...
      if (l = o.state, typeof o.componentWillMount == "function" && o.componentWillMount(), typeof o.UNSAFE_componentWillMount == "function" && o.UNSAFE_componentWillMount(), l !== o.state && _r.enqueueReplaceState(o, o.state, null), C.queue !== null && 0 < C.queue.length)
        if (l = C.queue, Y = C.replace, C.queue = null, C.replace = !1, Y && l.length === 1)
          ...
          for (C = Y ? l[0] : o.state, z = !0, Y = Y ? 1 : 0; Y < l.length; Y++) {
            var J = l[Y];
            J = typeof J == "function" ? J.call(o, C, M, v) : J, J != null && (z ? (z = !1, C = Mr({}, C, J)) : Mr(C, J));
          }
          o.state = C;
        }
      else
  ...
  var Jn = typeof Object.is == "function" ? Object.is : bo, jr = null, dn = null, Sn = null, Ze = null, Er = !1, Yt = !1, Hr = 0, Cr = null, mn = 0;
  function xr() {
    if (jr === null)
      throw Error(h(321));
    return jr;
  ...
  function Kn() {
    return Ze === null ? Sn === null ? (Er = !1, Sn = Ze = er()) : (Er = !0, Ze = Sn) : Ze.next === null ? (Er = !1, Ze = Ze.next = er()) : (Er = !0, Ze = Ze.next), Ze;
  }
  function qn() {
    dn = jr = null, Yt = !1, Sn = null, mn = 0, Ze = Cr = null;
  }
  function zA(o, l) {
  ...
  function kA(o, l, M) {
    if (jr = xr(), Ze = Kn(), Er) {
      ...
      if (l = v.dispatch, Cr !== null && (M = Cr.get(v), M !== void 0)) {
        Cr.delete(v), v = Ze.memoizedState;
        do
    ...
    return o = o === zA ? typeof l == "function" ? l() : l : M !== void 0 ? M(l) : l, Ze.memoizedState = o, o = Ze.queue = { last: null, dispatch: null }, o = o.dispatch = Oo.bind(null, jr, o), [Ze.memoizedState, o];
  }
  function bA(o, l) {
    if (jr = xr(), Ze = Kn(), l = l === void 0 ? null : l, Ze !== null) {
    ...
    return o = o(), Ze.memoizedState = [o, l], o;
  }
  function Oo(o, l, M) {
    if (25 <= mn)
      throw Error(h(301));
    if (o === jr)
      if (Yt = !0, o = { action: M, next: null }, Cr === null && (Cr = /* @__PURE__ */ new Map()), M = Cr.get(l), M === void 0)
        Cr.set(l, o);
      else {
        for (l = M; l.next !== null; )
          l = l.next;
  ...
  var Cn = { readContext: function(o) {
    ...
    return l === null ? (o = { current: o }, Ze.memoizedState = o) : l;
  }, useState: function(o) {
    return kA(zA, o);
  ...
  function _n(o, l, M, v, z, C, Y, J, ge) {
    ...
    return l = { destination: null, responseState: l, progressiveChunkSize: v === void 0 ? 12800 : v, status: 0, fatalError: null, nextSegmentId: 0, allPendingTasks: 0, pendingRootTasks: 0, completedRootSegment: null, abortableTasks: Te, pingedTasks: me, clientRenderedBoundaries: [], completedBoundaries: [], partialBoundaries: [], onError: z === void 0 ? Po : z, onAllReady: C === void 0 ? gn : C, onShellReady: Y === void 0 ? gn : Y, onShellError: J === void 0 ? gn : J, onFatalError: ge === void 0 ? gn : ge }, M = $r(l, 0, null, M, !1, !1), M.parentFlushed = !0, o = $n(l, o, null, M, Te, oe, null, Yr), me.push(o), l;
  }
  ...
  function OA(o, l, M, v, z) {
    for (jr = {}, dn = l, Hr = 0, o = M(v, z); Yt; )
      Yt = !1, Hr = 0, mn += 1, Ze = null, o = M(v, z);
    return qn(), o;
  }
  function eA(o, l, M, v) {
    ...
    if (C != null) {
      ...
      l.legacyContext = v, Ht(o, l, z), l.legacyContext = Y;
    } else
      Ht(o, l, z);
  }
  function QA(o, l) {
  ...
  function kn(o, l, M, v, z) {
    if (typeof M == "function")
      ...
      switch (z = l.blockedSegment, C = ir(z.chunks, M, v, o.responseState, z.formatContext), z.lastPushedText = !1, Y = z.formatContext, z.formatContext = je(Y, M, v), bn(o, l, C), z.formatContext = Y, M) {
        case "area":
        case "base":
        case "br":
        case "col":
      ...
      switch (M) {
        ...
        case Kr:
          e: {
            ...
            var me = $r(o, 0, null, z.formatContext, !1, !1);
            ...
            try {
              if (bn(
                ...
                l,
                v
              ), me.lastPushedText && me.textEmbedded && me.chunks.push(Ce), me.status = 1, On(J, me), J.pendingTasks === 0)
                break e;
            } catch (Te) {
              me.status = 4, J.forceClientRender = !0, J.errorDigest = en(o, Te);
            } finally {
      ...
      if (typeof M == "object" && M !== null)
        switch (M.$$typeof) {
          ...
          case A:
            ...
            return;
          case Jr:
            if (z = v.children, M = M._context, v = v.value, C = M._currentValue, M._currentValue = v, Y = se, se = v = { parent: Y, depth: Y === null ? 0 : Y.depth + 1, context: M, parentValue: C, value: v }, l.context = v, Ht(o, l, z), o = se, o === null)
              throw Error(h(403));
            v = o.parentValue, o.context._currentValue = v === m ? o.context._defaultValue : v, o = se = o.parent, l.context = o;
            return;
          case Sr:
            v = v.children, v = v(M._currentValue), Ht(o, l, v);
            return;
          case s:
  ...
  function Ht(o, l, M) {
    ...
    typeof M == "string" ? (v = l.blockedSegment, v.lastPushedText = vt(l.blockedSegment.chunks, M, o.responseState, v.lastPushedText)) : typeof M == "number" && (v = l.blockedSegment, v.lastPushedText = vt(l.blockedSegment.chunks, "" + M, o.responseState, v.lastPushedText));
  }
  function PA(o, l, M) {
    for (var v = M.length, z = 0; z < v; z++) {
      var C = l.treeContext;
      l.treeContext = Nr(C, v, z);
      try {
        bn(o, l, M[z]);
      } finally {
        l.treeContext = C;
  ...
  function bn(o, l, M) {
    ...
    try {
      ...
      if (qn(), typeof ge == "object" && ge !== null && typeof ge.then == "function") {
        ...
        Y.children.push(J), Y.lastPushedText = !1, o = $n(o, l.node, l.blockedBoundary, J, l.abortSet, l.legacyContext, l.context, l.treeContext).ping, M.then(o, o), l.blockedSegment.formatContext = v, l.legacyContext = z, l.context = C, $t(C);
      } else
        throw l.blockedSegment.formatContext = v, l.legacyContext = z, l.context = C, $t(C), ge;
    }
  }
  function Bo(o) {
      ...
      try {
        ...
        for (C = 0; C < z.length; C++) {
          ...
          if (ge.status === 0) {
            $t(Y.context);
            try {
              Ht(J, Y, Y.node), ge.lastPushedText && ge.textEmbedded && ge.chunks.push(Ce), Y.abortSet.delete(Y), ge.status = 1, UA(J, Y.blockedBoundary, ge);
            } catch (rr) {
              if (qn(), typeof rr == "object" && rr !== null && typeof rr.then == "function") {
                ...
                var Te = Y.blockedBoundary, Ke = rr, Ft = en(J, Ke);
                if (Te === null ? zn(J, Ke) : (Te.pendingTasks--, Te.forceClientRender || (Te.forceClientRender = !0, Te.errorDigest = Ft, Te.parentFlushed && J.clientRenderedBoundaries.push(Te))), J.allPendingTasks--, J.allPendingTasks === 0) {
                  var tr = J.onAllReady;
                  tr();
                }
              }
  ...
  function Qn(o, l, M) {
    switch (M.parentFlushed = !0, M.status) {
      case 0:
        ...
        return M.lastPushedText = !1, M.textEmbedded = !1, o = o.responseState, f(l, Je), f(l, o.placeholderPrefix), o = j(v.toString(16)), f(l, o), R(l, Jt);
      case 1:
        M.status = 2;
        var z = !0;
        v = M.chunks;
  ...
  function Pn(o, l, M) {
    ...
    if (v.parentFlushed = !0, v.forceClientRender)
      v = v.errorDigest, R(l, qt), f(l, lr), v && (f(l, ae), f(l, j(le(v))), f(l, K)), R(l, pe), Qn(o, l, M);
      ...
      z = E(z.boundaryPrefix + C.toString(16)), v = v.id = z, ue(l, o.responseState, v), Qn(o, l, M);
    } else if (v.byteSize > o.progressiveChunkSize)
      v.rootSegmentID = o.nextSegmentId++, o.completedBoundaries.push(v), ue(l, o.responseState, v.id), Qn(o, l, M);
    else {
  ...
  function HA(o, l, M) {
    for (var v = M.completedSegments, z = 0; z < v.length; z++)
      FA(o, l, M, v[z]);
    if (v.length = 0, o = o.responseState, v = M.id, M = M.rootSegmentID, f(l, o.startInlineScript), o.sentCompleteBoundaryFunction ? f(l, ot) : (o.sentCompleteBoundaryFunction = !0, f(l, Re)), v === null)
      throw Error(h(395));
    return M = j(M.toString(16)), f(l, v), f(l, Bt), f(l, o.segmentPrefix), f(l, M), R(l, cr);
  }
  function FA(o, l, M, v) {
    if (v.status === 2)
      return !0;
    ...
    return YA(o, l, v), o = o.responseState, f(l, o.startInlineScript), o.sentCompleteSegmentFunction ? f(l, Ie) : (o.sentCompleteSegmentFunction = !0, f(l, xe)), f(l, o.segmentPrefix), z = j(z.toString(16)), f(l, z), f(l, ct), f(l, o.placeholderPrefix), f(l, z), R(l, Ue);
  }
  function tA(o, l) {
    S = new Uint8Array(512), k = 0;
    try {
      ...
      for (C = 0; C < z.length; C++) {
        var Y = z[C];
        v = l;
        var J = o.responseState, ge = Y.id, me = Y.errorDigest, Te = Y.errorMessage, Ke = Y.errorComponentStack;
        if (f(v, J.startInlineScript), J.sentClientRenderFunction ? f(v, dt) : (J.sentClientRenderFunction = !0, f(
          v,
          ft
        )), ge === null)
          throw Error(h(395));
        f(v, ge), f(v, fr), (me || Te || Ke) && (f(v, wt), f(v, j(dr(me || "")))), (Te || Ke) && (f(v, wt), f(v, j(dr(Te || "")))), Ke && (f(v, wt), f(v, j(dr(Ke)))), R(v, _t);
      }
      z.splice(0, C);
      var Ft = o.completedBoundaries;
      for (C = 0; C < Ft.length; C++)
        HA(o, l, Ft[C]);
      Ft.splice(0, C), W(l), S = new Uint8Array(512), k = 0;
  ...
  return va.renderToReadableStream = function(o, l) {
    return new Promise(function(M, v) {
      var z, C, Y = new Promise(function(Te, Ke) {
        C = Te, z = Ke;
      }), J = _n(o, rt(l ? l.identifierPrefix : void 0, l ? l.nonce : void 0, l ? l.bootstrapScriptContent : void 0, l ? l.bootstrapScripts : void 0, l ? l.bootstrapModules : void 0), bt(l ? l.namespaceURI : void 0), l ? l.progressiveChunkSize : void 0, l ? l.onError : void 0, C, function() {
        var Te = new ReadableStream({ type: "bytes", pull: function(Ke) {
          if (J.status === 1)
            J.status = 2, G(Ke, J.fatalError);
      ...
      if (l && l.signal) {
        var ge = l.signal, me = function() {
          WA(J, ge.reason), ge.removeEventListener("abort", me);
        };
        ge.addEventListener("abort", me);
      }
      RA(J);
    });
...
function Ts() {
  return ku || (ku = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var Ae = Object.prototype.hasOwnProperty, ye = 0, le = 1, be = 2, we = 3, Ee = 4, Ye = 5, ke = 6, We = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", Le = We + "\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040", Be = new RegExp("^[" + We + "][" + Le + "]*$"), Xe = {}, tt = {};
    function rt(e) {
      return Ae.call(tt, e) ? !0 : Ae.call(Xe, e) ? !1 : Be.test(e) ? (tt[e] = !0, !0) : (Xe[e] = !0, f("Invalid attribute name: `%s`", e), !1);
    }
    function gt(e, r, i, u) {
      if (i !== null && i.type === ye)
        return !1;
    ...
    function je(e, r, i, u, d, D, w) {
      this.acceptsBooleans = r === be || r === we || r === Ee, this.attributeName = u, this.attributeNamespace = d, this.mustUseProperty = i, this.propertyName = e, this.type = r, this.sanitizeURL = D, this.removeEmptyString = w;
    }
    var Ce = {}, vt = [
      "children",
    ...
    var Ge = {
      ...
      "aria-rowspan": 0,
      "aria-setsize": 0
    }, yt = {}, jt = new RegExp("^(aria)-[" + Le + "]*$"), mt = new RegExp("^(aria)[A-Z][" + Le + "]*$");
    function Zt(e, r) {
      {
        if (Ae.call(yt, r) && yt[r])
          return !0;
        if (mt.test(r)) {
          var i = "aria-" + r.slice(4).toLowerCase(), u = Ge.hasOwnProperty(i) ? i : null;
          if (u == null)
            return f("Invalid ARIA attribute `%s`. ARIA attributes follow the pattern aria-* and must be lowercase.", r), yt[r] = !0, !0;
          if (r !== u)
            return f("Invalid ARIA attribute `%s`. Did you mean `%s`?", r, u), yt[r] = !0, !0;
        }
        if (jt.test(r)) {
          var d = r.toLowerCase(), D = Ge.hasOwnProperty(d) ? d : null;
          if (D == null)
            return yt[r] = !0, !1;
          if (r !== D)
            return f("Unknown ARIA attribute `%s`. Did you mean `%s`?", r, D), yt[r] = !0, !0;
        }
      }
      return !0;
    }
    ...
    function Ir(e, r) {
      {
        if (e !== "input" && e !== "textarea" && e !== "select")
          return;
        r != null && r.value === null && !Xt && (Xt = !0, e === "select" && r.multiple ? f("`value` prop on `%s` should not be null. Consider using an empty array when `multiple` is set to `true` to clear the component or `undefined` for uncontrolled components.", e) : f("`value` prop on `%s` should not be null. Consider using an empty string to clear the component or `undefined` for uncontrolled components.", e));
      }
    }
    var It = {
      // HTML
    ...
    {
      var nt = {}, ir = /^on./, ar = /^on[^A-Z]/, Pt = new RegExp("^(aria)-[" + Le + "]*$"), Je = new RegExp("^(aria)[A-Z][" + Le + "]*$");
      at = function(e, r, i, u) {
        ...
        var V = bt(r), te = V !== null && V.type === ye;
        ...
        return typeof i == "boolean" && gt(r, i, V, !1) ? (i ? f('Received `%s` for a non-boolean attribute `%s`.\n\nIf you want to write it to the DOM, pass a string instead: %s="%s" or %s={value.toString()}.', i, r, r, i, r) : f('Received `%s` for a non-boolean attribute `%s`.\n\nIf you want to write it to the DOM, pass a string instead: %s="%s" or %s={value.toString()}.\n\nIf you used to conditionally omit it with %s={condition && value}, pass %s={condition ? value : undefined} instead.', i, r, r, i, r, r, r), nt[r] = !0, !0) : te ? !0 : gt(r, i, V, !1) ? (nt[r] = !0, !1) : ((i === "false" || i === "true") && V !== null && V.type === we && (f("Received the string `%s` for the boolean attribute `%s`. %s Did you mean %s={%s}?", i, r, i === "false" ? "The browser will interpret it as a truthy value." : 'Although this works, it will not work as expected if you pass the string "false".', r, i), nt[r] = !0), !0);
      };
    }
    var Jt = function(e, r, i) {
      {
        var u = [];
        for (var d in r) {
          var D = at(e, d, r[d], i);
    ...
    {
      var sr = /^(?:webkit|moz|o)[A-Z]/, qt = /^-ms-/, wr = /-(.)/g, lr = /;\s*$/, K = {}, ae = {}, pe = !1, ue = !1, De = function(e) {
        ...
        ae.hasOwnProperty(r) && ae[r] || (ae[r] = !0, f(`Style property values shouldn't contain a semicolon. Try "%s: %s" instead.`, e, r.replace(lr, "")));
      }, At = function(e, r) {
        pe || (pe = !0, f("`NaN` is an invalid value for the `%s` css style property.", e));
      }, ut = function(e, r) {
        ue || (ue = !0, f("`Infinity` is an invalid value for the `%s` css style property.", e));
      };
      Kt = function(e, r) {
        e.indexOf("-") > -1 ? ve(e) : sr.test(e) ? ne(e) : lr.test(r) && Oe(e, r), typeof r == "number" && (isNaN(r) ? At(e, r) : isFinite(r) || ut(e, r));
      };
    }
    var st = Kt, Lt = /["'&<>]/;
    function St(e) {
    ...
    var Z = "<script>", q = "<\/script>", fe = '<script src="', Se = '<script type="module" src="', ze = '" async=""><\/script>';
    function xe(e) {
      return he(e), ("" + e).replace(Ie, ct);
    }
    var Ie = /(<\/|<)(s)(cript)/gi, ct = function(e, r, i, u) {
      return "" + r + (i === "s" ? "\\u0073" : "\\u0053") + u;
    };
    function Ue(e, r, i, u, d) {
      var D = e === void 0 ? "" : e, w = r === void 0 ? Z : '<script nonce="' + $e(r) + '">', O = [];
    ...
    var Re = 0, ot = 1, Bt = 2, cr = 3, ft = 4, dt = 5, fr = 6, _t = 7;
    function wt(e, r) {
      return {
        insertionMode: e,
        selectedValue: r
    ...
    function Xr(e, r, i) {
      switch (r) {
        case "select":
          return wt(ot, i.value != null ? i.value : i.defaultValue);
        case "svg":
          return wt(Bt, null);
        case "math":
          return wt(cr, null);
      ...
      return e.insertionMode >= ft || e.insertionMode === Re ? wt(ot, null) : e;
    }
    var dr = null;
    function Mr(e) {
      ...
      for (var d in i)
        if (Ae.call(i, d)) {
          ...
          if (!(D == null || typeof D == "boolean" || D === "")) {
            ...
            V ? (w = $e(d), ce(D, d), O = $e(("" + D).trim())) : (st(d, D), w = Sr(d), typeof D == "number" ? D !== 0 && !Ae.call(Ot, d) ? O = D + "px" : O = "" + D : (ce(D, d), O = $e(("" + D).trim()))), u ? (u = !1, e.push(cn, w, Kr, O)) : e.push(qr, w, Kr, O);
          }
        }
      u || e.push(p);
    }
        ...
        if (d !== null) {
          ...
          switch (d.type) {
            case we:
              ...
              return;
            case Ee:
              u === !0 ? e.push(s, w, x) : u === !1 || e.push(s, w, g, $e(u), p);
              return;
            case Ye:
              isNaN(u) || e.push(s, w, g, $e(u), p);
              break;
            case ke:
              !isNaN(u) && u >= 1 && e.push(s, w, g, $e(u), p);
              break;
            default:
              d.sanitizeURL && ($(u, D), u = "" + u, an(u)), e.push(s, w, g, $e(u), p);
          }
        } else if (rt(i)) {
          switch (typeof u) {
            case "function":
    ...
    function oe(e, r, i) {
      if (r != null) {
        ...
        var u = r.__html;
        u != null && (he(u), e.push("" + u));
      }
    }
    var Me = !1, se = !1, Qe = !1, Rt = !1, Ct = !1, xt = !1, Lr = !1;
    function $t(e, r) {
      {
        var i = e[r];
        if (i != null) {
    ...
    function _r(e, r, i) {
      ht("select", r), $t(r, "value"), $t(r, "defaultValue"), r.value !== void 0 && r.defaultValue !== void 0 && !Qe && (f("Select elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled select element and remove one of these props. More info: https://reactjs.org/link/controlled-components"), Qe = !0), e.push(Yt("select"));
      var u = null, d = null;
      for (var D in r)
        if (Ae.call(r, D)) {
          var w = r[D];
    ...
    function mr(e) {
      ...
      return I.Children.forEach(e, function(i) {
        i != null && (r += i, !Ct && typeof i != "string" && typeof i != "number" && (Ct = !0, f("Cannot infer the option value of complex children. Pass a `value` prop or use a plain string as children to <option>.")));
      }), r;
    }
    var Yr = ' selected=""';
    function Nr(e, r, i, u) {
        ...
        if (Ae.call(r, te)) {
          ...
          switch (te) {
            case "children":
              ...
              break;
            case "selected":
              O = ie, Lr || (f("Use the `defaultValue` or `value` props on <select> instead of setting `selected` on <option>."), Lr = !0);
              break;
            case "dangerouslySetInnerHTML":
              V = ie;
              break;
      ...
      if (d != null) {
        var Ne;
        if (w !== null ? ($(w, "value"), Ne = "" + w) : (V !== null && (xt || (xt = !0, f("Pass a `value` prop if you set dangerouslyInnerHTML so React knows which value should be selected."))), Ne = mr(D)), N(d))
          ...
          $(d, "select.value"), "" + d === Ne && e.push(Yr);
      } else
        O && e.push(Yr);
      return e.push(B), oe(e, V, D), D;
    }
    function fn(e, r, i) {
      ht("input", r), r.checked !== void 0 && r.defaultChecked !== void 0 && !se && (f("%s contains an input of type %s with both checked and defaultChecked props. Input elements must be either controlled or uncontrolled (specify either the checked prop, or the defaultChecked prop, but not both). Decide between using a controlled or uncontrolled input element and remove one of these props. More info: https://reactjs.org/link/controlled-components", "A component", r.type), se = !0), r.value !== void 0 && r.defaultValue !== void 0 && !Me && (f("%s contains an input of type %s with both value and defaultValue props. Input elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled input element and remove one of these props. More info: https://reactjs.org/link/controlled-components", "A component", r.type), Me = !0), e.push(Yt("input"));
    ...
    function zo(e, r, i) {
      ht("textarea", r), r.value !== void 0 && r.defaultValue !== void 0 && !Rt && (f("Textarea elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled textarea and remove one of these props. More info: https://reactjs.org/link/controlled-components"), Rt = !0), e.push(Yt("textarea"));
...
` && e.push(dn), u !== null && ($(u, "value"), e.push(Dr("" + u))), null;
    }
    function ko(e, r, i, u) {
      e.push(Yt(i));
      for (var d in r)
    ...
    function Jn(e, r, i, u) {
      ...
      return e.push(B), oe(e, D, d), typeof d == "string" ? (e.push(Dr(d)), null) : d;
    }
    function jr(e, r, i, u) {
      e.push(Yt(i));
      var d = null, D = null;
        ...
        if (Ae.call(r, w)) {
          ...
          switch (w) {
            ...
            case "suppressHydrationWarning":
              break;
            default:
              rt(w) && typeof O != "function" && typeof O != "symbol" && e.push(s, w, g, $e(O), p);
              break;
          }
        }
      return e.push(B), oe(e, D, d), d;
    }
    var dn = `
`;
    function Sn(e, r, i, u) {
...
` ? e.push(dn, V) : (he(V), e.push("" + V)));
      }
      return typeof d == "string" && d[0] === `
` && e.push(dn), d;
    }
    var Ze = /^[a-zA-Z][a-zA-Z:_\.\-\d]*$/, Er = /* @__PURE__ */ new Map();
    function Yt(e) {
      var r = Er.get(e);
      if (r === void 0) {
        if (!Ze.test(e))
    ...
    function Cr(e, r, i, u, d) {
      switch (Et(r, i), Ir(r, i), ur(r, i, null), !i.suppressContentEditableWarning && i.contentEditable && i.children != null && f("A component is `contentEditable` and contains `children` managed by React. It is now your responsibility to guarantee that none of those nodes are unexpectedly modified or duplicated. This is probably not intentional."), d.insertionMode !== Bt && d.insertionMode !== cr && r.indexOf("-") === -1 && typeof i.is != "string" && r.toLowerCase() !== r && f("<%s /> is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.", r), r) {
        case "select":
          return _r(e, i, u);
        case "option":
          return Nr(e, i, u, d);
    ...
    function zn(e, r, i, u, d) {
      var D;
      return D = E(e, En), j(e, xn), i && (j(e, Po), j(e, $e(i)), j(e, Mn)), u && (j(e, gn), j(e, $e(u)), j(e, Mn)), d && (j(e, _n), j(e, $e(d)), j(e, Mn)), D = E(e, $n), D;
    }
    function OA(e, r) {
      return E(e, Cn);
    }
    ...
    var kn = '<div hidden id="', Ht = '">', PA = "</div>", bn = '<svg aria-hidden="true" style="display:none" id="', Bo = '">', BA = "</svg>", On = '<math aria-hidden="true" style="display:none" id="', UA = '">', RA = "</math>", Qn = '<table hidden id="', Pn = '">', YA = "</table>", HA = '<table hidden><tbody id="', FA = '">', tA = "</tbody></table>", WA = '<table hidden><tr id="', o = '">', l = "</tr></table>", M = '<table hidden><colgroup id="', v = '">', z = "</colgroup></table>";
    function C(e, r, i, u) {
      switch (i.insertionMode) {
        case Re:
        case ot:
          return j(e, kn), j(e, r.segmentPrefix), j(e, u.toString(16)), E(e, Ht);
        case Bt:
    ...
    var wa = me + ';$RX("', Ta = '$RX("', Sa = '"', ma = ")<\/script>", Uo = ",";
    ...
    function xi(e, r, i, u) {
      return i.generateStaticMarkup ? (e.push($e(r)), !1) : sn(e, r, i, u);
    }
    function zi(e, r, i, u) {
...
`), V = u.stack.split(`
`), te = O.length - 1, ie = V.length - 1; te >= 1 && ie >= 0 && O[te] !== V[ie]; )
            ie--;
          for (; te >= 1 && ie >= 0; te--, ie--)
            if (O[te] !== V[ie]) {
              if (te !== 1 || ie !== 1)
                do
                  if (te--, ie--, ie < 0 || O[te] !== V[ie]) {
                    var Ne = `
` + O[te].replace(" at new ", " at ");
      ...
      var it = e ? e.displayName || e.name : "", kt = it ? sA(it) : "";
      return typeof e == "function" && qA.set(e, kt), kt;
    }
    function ei(e, r, i) {
      return $o(e, !0);
    }
      ...
      var O = new e(r, u);
      {
        ...
        if (typeof e.getDerivedStateFromProps == "function" || typeof O.getSnapshotBeforeUpdate == "function") {
          ...
          if (typeof O.componentWillMount == "function" && O.componentWillMount.__suppressDeprecationWarning !== !0 ? te = "componentWillMount" : typeof O.UNSAFE_componentWillMount == "function" && (te = "UNSAFE_componentWillMount"), typeof O.componentWillReceiveProps == "function" && O.componentWillReceiveProps.__suppressDeprecationWarning !== !0 ? ie = "componentWillReceiveProps" : typeof O.UNSAFE_componentWillReceiveProps == "function" && (ie = "UNSAFE_componentWillReceiveProps"), typeof O.componentWillUpdate == "function" && O.componentWillUpdate.__suppressDeprecationWarning !== !0 ? Ne = "componentWillUpdate" : typeof O.UNSAFE_componentWillUpdate == "function" && (Ne = "UNSAFE_componentWillUpdate"), te !== null || ie !== null || Ne !== null) {
            var it = Mt(e) || "Component", kt = typeof e.getDerivedStateFromProps == "function" ? "getDerivedStateFromProps()" : "getSnapshotBeforeUpdate()";
...
https://reactjs.org/link/unsafe-component-lifecycles`, it, kt, te !== null ? `
  ` + te : "", ie !== null ? `
  ` + ie : "", Ne !== null ? `
  ` + Ne : ""));
          }
...
Please update the following components: %s`,
      ...
      if (e.queue !== null && e.queue.length > 0) {
        ...
        if (e.queue = null, e.replace = !1, D && d.length === 1)
          ...
          for (var w = D ? d[0] : r.state, O = !0, V = D ? 1 : 0; V < d.length; V++) {
            var te = d[V], ie = typeof te == "function" ? te.call(r, w, i, u) : te;
    ...
    function si(e, r, i) {
      ...
      if (V > 30) {
        var te = D - D % 5, ie = (1 << te) - 1, Ne = (w & ie).toString(32), it = w >> te, kt = D - te, vr = fo(r) + kt, ha = O << kt, ya = ha | it, pa = Ne + d;
        return {
          id: 1 << vr | ya,
          overflow: pa
        };
      } else {
        var Eo = O << D, Gu = Eo | w, Zu = d;
        return {
          id: 1 << V | Gu,
          overflow: Zu
        };
    ...
    var Mo = typeof Object.is == "function" ? Object.is : li, Pe = null, vn = null, Dn = null, Ve = null, hr = !1, Ln = !1, go = 0, zt = null, Wr = 0, Nn = 25, kr = !1, jn;
    function Vr() {
      if (Pe === null)
...
See https://reactjs.org/link/invalid-hook-call for tips about how to debug and fix this problem.`);
      return kr && f("Do not call Hooks inside useEffect(...), useMemo(...), or other built-in Hooks. You can only call Hooks at the top level of your React function. For more information, see https://reactjs.org/link/rules-of-hooks"), Pe;
    }
    function Ga(e, r) {
      if (r === null)
...
Incoming: %s`, jn, "[" + e.join(", ") + "]", "[" + r.join(", ") + "]");
    ...
    function ho() {
      return Ve === null ? Dn === null ? (hr = !1, Dn = Ve = Ji()) : (hr = !0, Ve = Dn) : Ve.next === null ? (hr = !1, Ve = Ve.next = Ji()) : (hr = !0, Ve = Ve.next), Ve;
    }
    function ci(e, r) {
      Pe = r, vn = e, kr = !1, go = 0;
    }
    ...
    function hA() {
      kr = !1, Pe = null, vn = null, Ln = !1, Dn = null, Wr = 0, zt = null, Ve = null;
    }
    function Xa(e) {
    ...
    function _i(e, r, i) {
      if (e !== yo && (jn = "useReducer"), Pe = Vr(), Ve = ho(), hr) {
        ...
        kr = !0;
        var te;
        e === yo ? te = typeof r == "function" ? r() : r : te = i !== void 0 ? i(r) : r, kr = !1, Ve.memoizedState = te;
        var ie = Ve.queue = {
          last: null,
          dispatch: null
        }, Ne = ie.dispatch = _a.bind(null, Pe, ie);
        return [Ve.memoizedState, Ne];
      }
    }
    function $i(e, r) {
      Pe = Vr(), Ve = ho();
      ...
      kr = !0;
      var D = e();
      return kr = !1, Ve.memoizedState = [D, i], D;
    }
    function Ka(e) {
      Pe = Vr(), Ve = ho();
...
` + u.stack;
    ...
    function gi(e, r, i, u, d, D, w, O, V) {
      ...
      it.parentFlushed = !0;
      var kt = DA(Ne, e, null, it, ie, tn, oi, co);
      return te.push(kt), Ne;
    }
    function No(e, r) {
      var i = e.pingedTasks;
    ...
    function Aa(e, r, i) {
      yr(r, "Suspense");
      var u = r.blockedBoundary, d = r.blockedSegment, D = i.fallback, w = i.children, O = /* @__PURE__ */ new Set(), V = Gr(e, O), te = d.chunks.length, ie = nn(
        e,
        te,
        V,
        d.formatContext,
      ...
      try {
        ...
        Ne.status = wn, V.forceClientRender = !0, V.errorDigest = LA(e, kt), pi(V, kt);
      } finally {
        r.blockedBoundary = u, r.blockedSegment = d;
      }
      var it = DA(e, D, u, ie, O, r.legacyContext, r.context, r.treeContext);
      it.componentStack = r.componentStack, e.pingedTasks.push(it), pr(r);
    }
    function oa(e, r, i, u) {
      yr(r, i);
      ...
      d.formatContext = Xr(w, i, u), Io(e, r, D), d.formatContext = w, er(d.chunks, i), d.lastPushedText = !1, pr(r);
    }
    function iu(e) {
    ...
    function au(e, r, i, u) {
      ...
      if (
        ...
        var ie = r.treeContext, Ne = 1, it = 0;
        r.treeContext = si(ie, Ne, it);
        try {
          or(e, r, w);
        } finally {
          r.treeContext = ie;
    ...
    function Ti(e, r, i, u, d) {
      ...
      switch (i) {
        ...
        case Wo: {
          yr(r, "SuspenseList"), or(e, r, u.children), pr(r);
          return;
        }
        case ka:
    ...
    function Si(e, r, i) {
      if (r.node = i, typeof i == "object" && i !== null) {
        switch (i.$$typeof) {
          ...
          case JA: {
            var O = i, V = O._payload, te = O._init, ie;
            try {
              ie = te(V);
            } catch (Eo) {
    ...
    function c(e, r, i, u) {
      ...
      var ie = gi(e, xa(i, r ? r.identifierPrefix : void 0), Yo(), 1 / 0, a, void 0, te, void 0, void 0);
...
function Ss() {
  return bu || (bu = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function ye(t, n) {
      if (he(t))
        return f("The provided `%s` attribute is an unsupported type %s. This value must be coerced to a string before before using it here.", n, ce(t)), Ae(t);
    }
    function le(t, n) {
      if (he(t))
        return f("The provided `%s` CSS property is an unsupported type %s. This value must be coerced to a string before before using it here.", n, ce(t)), Ae(t);
    }
    function be(t) {
      if (he(t))
        return f("The provided HTML markup uses a value of unsupported type %s. This value must be coerced to a string before before using it here.", ce(t)), Ae(t);
    }
    var we = Object.prototype.hasOwnProperty, Ee = 0, Ye = 1, ke = 2, We = 3, Le = 4, Be = 5, Xe = 6, tt = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", rt = tt + "\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040", gt = new RegExp("^[" + tt + "][" + rt + "]*$"), bt = {}, je = {};
    function Ce(t) {
      return we.call(je, t) ? !0 : we.call(bt, t) ? !1 : gt.test(t) ? (je[t] = !0, !0) : (bt[t] = !0, f("Invalid attribute name: `%s`", t), !1);
    }
    function vt(t, n, a, c) {
      if (a !== null && a.type === Ee)
        return !1;
    ...
    function qe(t, n, a, c, y, L, T) {
      this.acceptsBooleans = n === ke || n === We || n === Le, this.attributeName = c, this.attributeNamespace = y, this.mustUseProperty = a, this.propertyName = t, this.type = n, this.sanitizeURL = L, this.removeEmptyString = T;
    }
    var He = {}, Ot = [
      "children",
      "dangerouslySetInnerHTML",
    ...
    function jt(t, n) {
      yt[n.type] || n.onChange || n.onInput || n.readOnly || n.disabled || n.value == null || f("You provided a `value` prop to a form field without an `onChange` handler. This will render a read-only field. If the field should be mutable use `defaultValue`. Otherwise, set either `onChange` or `readOnly`."), n.onChange || n.readOnly || n.disabled || n.checked == null || f("You provided a `checked` prop to a form field without an `onChange` handler. This will render a read-only field. If the field should be mutable use `defaultChecked`. Otherwise, set either `onChange` or `readOnly`.");
    }
    function mt(t, n) {
      if (t.indexOf("-") === -1)
    ...
    var Zt = {
      ...
      "aria-rowspan": 0,
      "aria-setsize": 0
    }, Tt = {}, Et = new RegExp("^(aria)-[" + rt + "]*$"), Xt = new RegExp("^(aria)[A-Z][" + rt + "]*$");
    function Ir(t, n) {
      {
        if (we.call(Tt, n) && Tt[n])
          return !0;
        if (Xt.test(n)) {
          var a = "aria-" + n.slice(4).toLowerCase(), c = Zt.hasOwnProperty(a) ? a : null;
          if (c == null)
            return f("Invalid ARIA attribute `%s`. ARIA attributes follow the pattern aria-* and must be lowercase.", n), Tt[n] = !0, !0;
          if (n !== c)
            return f("Invalid ARIA attribute `%s`. Did you mean `%s`?", n, c), Tt[n] = !0, !0;
        }
        if (Et.test(n)) {
          var y = n.toLowerCase(), L = Zt.hasOwnProperty(y) ? y : null;
          if (L == null)
            return Tt[n] = !0, !1;
          if (n !== L)
            return f("Unknown ARIA attribute `%s`. Did you mean `%s`?", n, L), Tt[n] = !0, !0;
        }
      }
      return !0;
    }
    ...
    {
      var Je = {}, Jt = /^on./, ur = /^on[^A-Z]/, Kt = new RegExp("^(aria)-[" + rt + "]*$"), sr = new RegExp("^(aria)[A-Z][" + rt + "]*$");
      Pt = function(t, n, a, c) {
        if (we.call(Je, n) && Je[n])
          return !0;
        var y = n.toLowerCase();
        if (y === "onfocusin" || y === "onfocusout")
          return f("React uses onFocus and onBlur instead of onFocusIn and onFocusOut. All React events are normalized to bubble, so onFocusIn and onFocusOut are not needed/supported by React."), Je[n] = !0, !0;
        if (c != null) {
          ...
          if (Q != null)
            return f("Invalid event handler property `%s`. Did you mean `%s`?", n, Q), Je[n] = !0, !0;
          if (Jt.test(n))
            return f("Unknown event handler property `%s`. It will be ignored.", n), Je[n] = !0, !0;
        } else if (Jt.test(n))
          return ur.test(n) && f("Invalid event handler property `%s`. React events use the camelCase naming convention, for example `onClick`.", n), Je[n] = !0, !0;
        if (Kt.test(n) || sr.test(n))
          return !0;
        if (y === "innerhtml")
          return f("Directly setting property `innerHTML` is not permitted. For more information, lookup documentation on `dangerouslySetInnerHTML`."), Je[n] = !0, !0;
        if (y === "aria")
          return f("The `aria` attribute is reserved for future use in React. Pass individual `aria-` attributes instead."), Je[n] = !0, !0;
        if (y === "is" && a !== null && a !== void 0 && typeof a != "string")
          return f("Received a `%s` for a string attribute `is`. If this is expected, cast the value to a string.", typeof a), Je[n] = !0, !0;
        if (typeof a == "number" && isNaN(a))
          return f("Received NaN for the `%s` attribute. If this is expected, cast the value to a string.", n), Je[n] = !0, !0;
        var e = Dt(n), r = e !== null && e.type === Ee;
        if (ar.hasOwnProperty(y)) {
          var i = ar[y];
          if (i !== n)
            return f("Invalid DOM property `%s`. Did you mean `%s`?", n, i), Je[n] = !0, !0;
        } else if (!r && n !== y)
          return f("React does not recognize the `%s` prop on a DOM element. If you intentionally want it to appear in the DOM as a custom attribute, spell it as lowercase `%s` instead. If you accidentally passed it from a parent component, remove it from the DOM element.", n, y), Je[n] = !0, !0;
        return typeof a == "boolean" && vt(n, a, e, !1) ? (a ? f('Received `%s` for a non-boolean attribute `%s`.\n\nIf you want to write it to the DOM, pass a string instead: %s="%s" or %s={value.toString()}.', a, n, n, a, n) : f('Received `%s` for a non-boolean attribute `%s`.\n\nIf you want to write it to the DOM, pass a string instead: %s="%s" or %s={value.toString()}.\n\nIf you used to conditionally omit it with %s={condition && value}, pass %s={condition ? value : undefined} instead.', a, n, n, a, n, n, n), Je[n] = !0, !0) : r ? !0 : vt(n, a, e, !1) ? (Je[n] = !0, !1) : ((a === "false" || a === "true") && e !== null && e.type === We && (f("Received the string `%s` for the boolean attribute `%s`. %s Did you mean %s={%s}?", a, n, a === "false" ? "The browser will interpret it as a truthy value." : 'Although this works, it will not work as expected if you pass the string "false".', n, a), Je[n] = !0), !0);
      };
    }
    var qt = function(t, n, a) {
      {
        var c = [];
        for (var y in n) {
          var L = Pt(t, y, n[y], a);
    ...
    {
      var K = /^(?:webkit|moz|o)[A-Z]/, ae = /^-ms-/, pe = /-(.)/g, ue = /;\s*$/, De = {}, ve = {}, ne = !1, Oe = !1, At = function(t) {
        return t.replace(pe, function(n, a) {
          return a.toUpperCase();
        });
      }, ut = function(t) {
        De.hasOwnProperty(t) && De[t] || (De[t] = !0, f(
          "Unsupported style property %s. Did you mean %s?",
          t,
          // As Andi Smith suggests
          // (http://www.andismith.com/blog/2012/02/modernizr-prefixed/), an `-ms` prefix
        ...
        De.hasOwnProperty(t) && De[t] || (De[t] = !0, f("Unsupported vendor-prefixed style property %s. Did you mean %s?", t, t.charAt(0).toUpperCase() + t.slice(1)));
      }, Lt = function(t, n) {
        ve.hasOwnProperty(n) && ve[n] || (ve[n] = !0, f(`Style property values shouldn't contain a semicolon. Try "%s: %s" instead.`, t, n.replace(ue, "")));
      }, St = function(t, n) {
        ne || (ne = !0, f("`NaN` is an invalid value for the `%s` css style property.", t));
      }, $e = function(t, n) {
        Oe || (Oe = !0, f("`Infinity` is an invalid value for the `%s` css style property.", t));
      };
      lr = function(t, n) {
        t.indexOf("-") > -1 ? ut(t) : K.test(t) ? st(t) : ue.test(n) && Lt(t, n), typeof n == "number" && (isNaN(n) ? St(t, n) : isFinite(n) || $e(t, n));
      };
    }
    var Pr = lr, Br = /["'&<>]/;
    function Ur(t) {
    ...
    var ze = b("<script>"), xe = b("<\/script>"), Ie = b('<script src="'), ct = b('<script type="module" src="'), Ue = b('" async=""><\/script>');
    function Re(t) {
      return be(t), ("" + t).replace(ot, Bt);
    }
    var ot = /(<\/|<)(s)(cript)/gi, Bt = function(t, n, a, c) {
      return "" + n + (a === "s" ? "\\u0073" : "\\u0053") + c;
    };
    function cr(t, n, a, c, y) {
      ...
      if (a !== void 0 && Q.push(T, H(Re(a)), xe), c !== void 0)
        for (var e = 0; e < c.length; e++)
          Q.push(Ie, H(lt(c[e])), Ue);
      if (y !== void 0)
        for (var r = 0; r < y.length; r++)
          Q.push(ct, H(lt(y[r])), Ue);
      return {
        bootstrapChunks: Q,
        startInlineScript: T,
    ...
    var ft = 0, dt = 1, fr = 2, _t = 3, wt = 4, Xr = 5, dr = 6, Mr = 7;
    function Ut(t, n) {
      return {
        insertionMode: t,
        selectedValue: n
    ...
    function Dr(t) {
      var n = t === "http://www.w3.org/2000/svg" ? fr : t === "http://www.w3.org/1998/Math/MathML" ? _t : ft;
      return Ut(n, null);
    }
    function Tr(t, n, a) {
      switch (n) {
        case "select":
          return Ut(dt, a.value != null ? a.value : a.defaultValue);
        case "svg":
          return Ut(fr, null);
        case "math":
          return Ut(_t, null);
      ...
      return t.insertionMode >= wt || t.insertionMode === ft ? Ut(dt, null) : t;
    }
    var sn = null;
    function ln(t) {
      ...
      for (var y in a)
        if (we.call(a, y)) {
          ...
          if (!(L == null || typeof L == "boolean" || L === "")) {
            ...
            e ? (T = H(lt(y)), le(L, y), Q = H(lt(("" + L).trim()))) : (Pr(y, L), T = s(y), typeof L == "number" ? L !== 0 && !we.call(ht, y) ? Q = H(L + "px") : Q = H("" + L) : (le(L, y), Q = H(lt(("" + L).trim())))), c ? (c = !1, t.push(g, T, p, Q)) : t.push(x, T, p, Q);
          }
        }
      c || t.push(oe);
    }
    var B = b(" "), X = b('="'), oe = b('"'), Me = b('=""');
    function se(t, n, a, c) {
      switch (a) {
        case "style": {
          m(t, n, c);
        ...
        if (y !== null) {
          ...
          switch (y.type) {
            case We:
              ...
              return;
            case Le:
              c === !0 ? t.push(B, T, Me) : c === !1 || t.push(B, T, X, H(lt(c)), oe);
              return;
            case Be:
              isNaN(c) || t.push(B, T, X, H(lt(c)), oe);
              break;
            case Xe:
              !isNaN(c) && c >= 1 && t.push(B, T, X, H(lt(c)), oe);
              break;
            default:
              y.sanitizeURL && (ye(c, L), c = "" + c, q(c)), t.push(B, T, X, H(lt(c)), oe);
          }
        } else if (Ce(a)) {
          switch (typeof c) {
            case "function":
    ...
    var xt = !1, Lr = !1, $t = !1, _r = !1, mr = !1, Yr = !1, Nr = !1;
    function fn(t, n) {
      {
        var a = t[n];
        if (a != null) {
    ...
    function zo(t, n, a) {
      jt("select", n), fn(n, "value"), fn(n, "defaultValue"), n.value !== void 0 && n.defaultValue !== void 0 && !$t && (f("Select elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled select element and remove one of these props. More info: https://reactjs.org/link/controlled-components"), $t = !0), t.push(er("select"));
      var c = null, y = null;
      for (var L in n)
        if (we.call(n, L)) {
          var T = n[L];
    ...
    function bo(t, n, a, c) {
      ...
      if (y != null) {
        var u;
        if (T !== null ? (ye(T, "value"), u = "" + T) : (e !== null && (Yr || (Yr = !0, f("Pass a `value` prop if you set dangerouslyInnerHTML so React knows which value should be selected."))), u = ko(L)), Se(y))
        ...
        Q && t.push(Xn);
      return t.push(Qe), Ct(t, e, L), L;
    }
    function Jn(t, n, a) {
      jt("input", n), n.checked !== void 0 && n.defaultChecked !== void 0 && !Lr && (f("%s contains an input of type %s with both checked and defaultChecked props. Input elements must be either controlled or uncontrolled (specify either the checked prop, or the defaultChecked prop, but not both). Decide between using a controlled or uncontrolled input element and remove one of these props. More info: https://reactjs.org/link/controlled-components", "A component", n.type), Lr = !0), n.value !== void 0 && n.defaultValue !== void 0 && !xt && (f("%s contains an input of type %s with both value and defaultValue props. Input elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled input element and remove one of these props. More info: https://reactjs.org/link/controlled-components", "A component", n.type), xt = !0), t.push(er("input"));
      ...
      return L !== null ? se(t, a, "checked", L) : T !== null && se(t, a, "checked", T), c !== null ? se(t, a, "value", c) : y !== null && se(t, a, "value", y), t.push(Rt), null;
    }
    function jr(t, n, a) {
      jt("textarea", n), n.value !== void 0 && n.defaultValue !== void 0 && !_r && (f("Textarea elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled textarea and remove one of these props. More info: https://reactjs.org/link/controlled-components"), _r = !0), t.push(er("textarea"));
      ...
      if (c === null && y !== null && (c = y), t.push(Qe), L != null) {
      ...
      return typeof c == "string" && c[0] === `
` && t.push(Hr), c !== null && (ye(c, "value"), t.push(H(Sr("" + c)))), null;
    }
    function dn(t, n, a, c) {
      t.push(er(a));
      for (var y in n)
    ...
    function Er(t, n, a, c) {
      ...
      return t.push(Qe), Ct(t, L, y), typeof y == "string" ? (t.push(H(Sr(y))), null) : y;
    }
    function Yt(t, n, a, c) {
      t.push(er(a));
      var y = null, L = null;
        ...
        if (we.call(n, T)) {
          ...
          switch (T) {
            ...
            case "suppressHydrationWarning":
              break;
            default:
              Ce(T) && typeof Q != "function" && typeof Q != "symbol" && t.push(B, H(T), X, H(lt(Q)), oe);
              break;
          }
        }
      return t.push(Qe), Ct(t, L, y), y;
    }
    var Hr = b(`
`);
    function Cr(t, n, a, c) {
...
` && t.push(Hr), y;
    ...
    function qn(t, n, a, c, y) {
      switch (at(n, a), ir(n, a), wr(n, a, null), !a.suppressContentEditableWarning && a.contentEditable && a.children != null && f("A component is `contentEditable` and contains `children` managed by React. It is now your responsibility to guarantee that none of those nodes are unexpectedly modified or duplicated. This is probably not intentional."), y.insertionMode !== fr && y.insertionMode !== _t && n.indexOf("-") === -1 && typeof a.is != "string" && n.toLowerCase() !== n && f("<%s /> is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.", n), n) {
        case "select":
          return zo(t, a, c);
        case "option":
          return bo(t, a, c, y);
        ...
        default:
          return n.indexOf("-") === -1 && typeof a.is != "string" ? Er(t, a, n, c) : Yt(t, a, n, c);
      }
    }
    var zA = b("</"), kA = b(">");
    function bA(t, n, a) {
    ...
    var BA = b('<div hidden id="'), On = b('">'), UA = b("</div>"), RA = b('<svg aria-hidden="true" style="display:none" id="'), Qn = b('">'), Pn = b("</svg>"), YA = b('<math aria-hidden="true" style="display:none" id="'), HA = b('">'), FA = b("</math>"), tA = b('<table hidden id="'), WA = b('">'), o = b("</table>"), l = b('<table hidden><tbody id="'), M = b('">'), v = b("</tbody></table>"), z = b('<table hidden><tr id="'), C = b('">'), Y = b("</tr></table>"), J = b('<table hidden><colgroup id="'), ge = b('">'), me = b("</colgroup></table>");
    function Te(t, n, a, c) {
    ...
    var Ft = "function $RS(a,b){a=document.getElementById(a);b=document.getElementById(b);for(a.parentNode.removeChild(a);a.firstChild;)b.parentNode.insertBefore(a.firstChild,b);b.parentNode.removeChild(b)}", tr = 'function $RC(a,b){a=document.getElementById(a);b=document.getElementById(b);b.parentNode.removeChild(b);if(a){a=a.previousSibling;var f=a.parentNode,c=a.nextSibling,e=0;do{if(c&&8===c.nodeType){var d=c.data;if("/$"===d)if(0===e)break;else e--;else"$"!==d&&"$?"!==d&&"$!"!==d||e++}d=c.nextSibling;f.removeChild(c);c=d}while(c);for(;b.firstChild;)f.insertBefore(b.firstChild,c);a.data="$";a._reactRetry&&a._reactRetry()}}', rr = 'function $RX(b,c,d,e){var a=document.getElementById(b);a&&(b=a.previousSibling,b.data="$!",a=a.dataset,c&&(a.dgst=c),d&&(a.msg=d),e&&(a.stck=e),b._reactRetry&&b._reactRetry())}', Bn = b(Ft + ';$RS("'), VA = b('$RS("'), rA = b('","'), ja = b('")<\/script>');
    function Ia(t, n, a) {
...
Please update the following components: %s`,
    ...
    var Va = typeof Object.is == "function" ? Object.is : Wa, Fr = null, li = null, Mo = null, Pe = null, vn = !1, Dn = !1, Ve = 0, hr = null, Ln = 0, go = 25, zt = !1, Wr;
    function Nn() {
      if (Fr === null)
        throw new Error(`Invalid hook call. Hooks can only be called inside of the body of a function component. This could happen for one of the following reasons:
1. You might have mismatching versions of React and the renderer (such as React DOM)
...
3. You might have more than one copy of React in the same app
See https://reactjs.org/link/invalid-hook-call for tips about how to debug and fix this problem.`);
      return zt && f("Do not call Hooks inside useEffect(...), useMemo(...), or other built-in Hooks. You can only call Hooks at the top level of your React function. For more information, see https://reactjs.org/link/rules-of-hooks"), Fr;
    }
    function kr(t, n) {
      if (n === null)
...
Incoming: %s`, Wr, "[" + t.join(", ") + "]", "[" + n.join(", ") + "]");
    ...
    function Vr() {
      return Pe === null ? Mo === null ? (vn = !1, Mo = Pe = jn()) : (vn = !0, Pe = Mo) : Pe.next === null ? (vn = !1, Pe = Pe.next = jn()) : (vn = !0, Pe = Pe.next), Pe;
    }
    function Ga(t, n) {
      Fr = n, li = t, zt = !1, Ve = 0;
    }
    function Ji(t, n, a, c) {
      for (; Dn; )
        Dn = !1, Ve = 0, Ln += 1, Pe = null, a = t(n, c);
      return ci(), a;
    }
    function ho() {
      var t = Ve !== 0;
    ...
    function ci() {
      zt = !1, Fr = null, li = null, Dn = !1, Mo = null, Ln = 0, hr = null, Pe = null;
    }
    function Za(t) {
      return zt && f("Context can only be read while React is rendering. In classes, you can read it in the render method or getDerivedStateFromProps. In function components, you can read it directly in the function body, but not inside Hooks like useReducer() or useMemo()."), dA(t);
    }
    function Ki(t) {
    ...
    function qi(t, n, a) {
      if (t !== hA && (Wr = "useReducer"), Fr = Nn(), Pe = Vr(), vn) {
        var c = Pe.queue, y = c.dispatch;
        if (hr !== null) {
          var L = hr.get(c);
          if (L !== void 0) {
            hr.delete(c);
            var T = Pe.memoizedState, Q = L;
            do {
              var e = Q.action;
              zt = !0, T = t(T, e), zt = !1, Q = Q.next;
            } while (Q !== null);
            return Pe.memoizedState = T, [T, y];
          }
        }
        return [Pe.memoizedState, y];
      } else {
        zt = !0;
        var r;
        t === hA ? r = typeof n == "function" ? n() : n : r = a !== void 0 ? a(n) : n, zt = !1, Pe.memoizedState = r;
        var i = Pe.queue = {
          last: null,
          dispatch: null
    ...
    function yo(t, n) {
      ...
      zt = !0;
      var L = t();
      return zt = !1, Pe.memoizedState = [L, a], L;
    }
    function Ja(t) {
      Fr = Nn(), Pe = Vr();
      ...
      if (n === null) {
        ...
        return Object.seal(a), Pe.memoizedState = a, a;
      } else
        return n;
    }
    function _i(t, n) {
...
` + c.stack;
    ...
    function wi(t, n, a, c, y) {
      ...
      switch (a) {
        ...
        case AA: {
          nn(n, "SuspenseList"), Ar(t, n, c.children), yr(n);
          return;
        }
        case Wo:
          throw new Error("ReactDOMServer does not yet support scope components.");
        ...
        switch (a.$$typeof) {
          ...
          case Un: {
            ...
            try {
              ...
              throw typeof ie == "object" && ie !== null && typeof ie.then == "function" && nn(n, "Lazy"), ie;
            }
            Ar(t, n, i);
            return;
          }
    ...
    function To(t, n, a) {
      ...
      if (c.parentFlushed = !0, c.forceClientRender)
        return Ht(n, t.responseState, c.errorDigest, c.errorMessage, c.errorComponentStack), wA(t, n, a), Bo(n, t.responseState);
      if (c.pendingTasks > 0) {
    ...
    function TA(t, n, a) {
      return Te(n, t.responseState, a.formatContext, a.id), To(t, n, a), Ke(n, a.formatContext);
    }
    function SA(t, n, a) {
...
const Ou = async (I) => {
  ...
  localStorage.setItem(Nu, JSON.stringify(k));
}, Cs = (I) => {
  if (I != null)
    try {
      return JSON.parse(I);
  ...
  var h, S, k;
  Nu = (h = I.chatHistory) == null ? void 0 : h.storageKey, La = (S = I.chatHistory) == null ? void 0 : S.maxEntries, Wu = (k = I.chatHistory) == null ? void 0 : k.disabled, ju = Cs(localStorage.getItem(Nu));
}, zs = (I) => Xu(I.content) ? structuredClone({
  content: xA.renderToString(I.content),
  type: "object",
  sender: I.sender
}) : { ...I, type: "string" }, Qu = (I, h, S, k) => {
  var f;
  if (Fu = !0, h != null)
    try {
      S((W) => {
      ...
      setTimeout(() => {
        ...
        }), k(((W = I.chatInput) == null ? void 0 : W.disabled) || !1);
      }, 500);
    } catch {
      localStorage.removeItem((f = I.chatHistory) == null ? void 0 : f.storageKey);
    }
}, Vu = (I, h) => {
  const k = new DOMParser().parseFromString(I, "text/html");
  return Array.from(k.body.childNodes).map((W, U) => {
    var j;
    if (W.nodeType === Node.TEXT_NODE)
      return W.textContent;
    {
      const E = W.tagName.toLowerCase();
      let G = Array.from(W.attributes).reduce((de, ee) => {
        const re = ee.name.toLowerCase();
        if (re === "style") {
          const H = ee.value.split(";").filter(($) => $.trim() !== ""), b = {};
          H.forEach(($) => {
            const [ce, he] = $.split(":").map((ye) => ye.trim()), Ae = ce.replace(/-([a-z])/g, (ye, le) => le.toUpperCase());
            b[Ae] = he;
          }), de[re] = b;
        } else
          de[re] = ee.value;
  ...
  return I.contains("rcb-options") && (h.style = {
    ...h.style,
    color: ((k = S.botOptionStyle) == null ? void 0 : k.color) || ((f = S.theme) == null ? void 0 : f.primaryColor),
  ...
  return I.contains("rcb-checkbox-row-container") && (h.style = {
    ...h.style,
    color: ((k = S.botCheckboxRowStyle) == null ? void 0 : k.color) || ((f = S.theme) == null ? void 0 : f.primaryColor),
  ...
  return I.contains("rcb-checkbox-next-button") && (h.style = {
    ...h.style,
    color: ((k = S.botCheckboxNextStyle) == null ? void 0 : k.color) || ((f = S.theme) == null ? void 0 : f.primaryColor),
  ...
  R.text = I, R.lang = h, R.rate = k, R.volume = f;
  let W = !1;
  for (const U in S)
  ...
  var k, f, R, W, U, j;
  (k = I.audio) != null && k.disabled || S.sender === "user" || typeof S.content != "string" || !(I != null && I.isOpen) && !((f = I.theme) != null && f.embedded) || !h || Ps(
    S.content,
...
const Us = ({ flow: I }) => {
  var Pt, Je, Jt, ur, Kt, sr, qt, wr, lr;
  const { botOptions: h, setBotOptions: S } = Vt(), { messages: k, setMessages: f } = Ru(), { paths: R, setPaths: W } = Na(), U = Zr(null), j = Zr(null), E = Zr(""), G = Zr(!1), P = Zr(!1), _ = Zr(null), de = Zr(), ee = Zr(null), [re, H] = Fe(!1), [b, $] = Fe(!0), [ce, he] = Fe(!1), [Ae, ye] = Fe(!1), [le, be] = Fe(!1), [we, Ee] = Fe(!1), [Ye, ke] = Fe(!1), [We, Le] = Fe(!1), [Be, Xe] = Fe(0), [tt, rt] = Fe(!1), [gt, bt] = Fe(), [je, Ce] = Fe(0), [vt, Dt] = Fe(((Pt = window.visualViewport) == null ? void 0 : Pt.height) || window.innerHeight), [qe, He] = Fe(((Je = window.visualViewport) == null ? void 0 : Je.width) || window.innerWidth), Ot = Zr(0);
  Wt(() => {
    var K, ae, pe, ue, De, ve, ne;
    if (window.addEventListener("click", _e), window.addEventListener("keydown", _e), window.addEventListener("touchstart", _e), Nt(), be((K = h.chatInput) == null ? void 0 : K.disabled), he((ae = h.audio) == null ? void 0 : ae.defaultToggledOn), ye((pe = h.voice) == null ? void 0 : pe.defaultToggledOn), (ue = h.chatHistory) != null && ue.disabled)
      localStorage.removeItem((De = h.chatHistory) == null ? void 0 : De.storageKey);
    else {
      const Oe = localStorage.getItem((ve = h.chatHistory) == null ? void 0 : ve.storageKey);
      Oe != null && (f([{
        content: /* @__PURE__ */ F.jsx(ds, { chatHistory: Oe, showChatHistory: Tt }),
        sender: "system"
      }]), (ne = h.chatHistory) != null && ne.autoLoad && Qu(h, Oe, f, be));
    }
    return () => {
      window.removeEventListener("click", _e), window.removeEventListener("keydown", _e), window.removeEventListener("touchstart", _e);
    };
  }, []), Wt(() => {
    xs(h);
  }, [(Jt = h.chatHistory) == null ? void 0 : Jt.storageKey, (ur = h.chatHistory) == null ? void 0 : ur.maxEntries, (Kt = h.chatHistory) == null ? void 0 : Kt.disabled]), Wt(() => {
    var K;
    Qr || (K = h.theme) != null && K.embedded || navigator.virtualKeyboard && (navigator.virtualKeyboard.overlaysContent = !0, navigator.virtualKeyboard.addEventListener("geometrychange", (ae) => {
      if (!ae.target)
        return;
      const { x: pe, y: ue, width: De, height: ve } = ae.target.boundingRect;
      pe == 0 && ue == 0 && De == 0 && ve == 0 ? (setTimeout(() => {
        var ne;
        Dt((ne = window.visualViewport) == null ? void 0 : ne.height);
      }, 101), setTimeout(() => {
        var ne, Oe;
        vt != ((ne = window.visualViewport) == null ? void 0 : ne.height) && Dt((Oe = window.visualViewport) == null ? void 0 : Oe.height);
      }, 1001)) : setTimeout(() => {
        var ne;
        Dt(((ne = window.visualViewport) == null ? void 0 : ne.height) - ve);
      }, 101);
    }));
  }, []), Wt(() => {
    Ou(k), Gt();
    ...
    var De, ve, ne, Oe;
    if (h.isOpen && (Ce(0), Dt((De = window.visualViewport) == null ? void 0 : De.height), He((ve = window.visualViewport) == null ? void 0 : ve.width)), Qr)
      return;
    const K = () => window.scrollTo({ top: 0, left: 0, behavior: "auto" }), ae = () => Ot.current = window.scrollY, pe = () => {
      var At, ut;
      Dt((At = window.visualViewport) == null ? void 0 : At.height), He((ut = window.visualViewport) == null ? void 0 : ut.width);
    }, ue = () => {
      var At;
      window.removeEventListener("scroll", K), window.removeEventListener("scroll", ae), (At = window.visualViewport) == null || At.removeEventListener("resize", pe);
    };
    return h.isOpen ? (ue(), document.body.style.position = "fixed", window.addEventListener("scroll", K), (ne = window.visualViewport) == null || ne.addEventListener("resize", pe)) : (document.body.style.position = "static", ue(), window.scrollTo({ top: Ot.current, left: 0, behavior: "auto" }), window.addEventListener("scroll", ae), (Oe = window.visualViewport) == null || Oe.removeEventListener("resize", pe)), ue;
  }, [h.isOpen]), Wt(() => {
    const K = Ge();
    if (!K)
      return;
  ...
  const Qt = async (K, ae) => {
    ...
    var ue, De, ve;
    $((ue = h.notification) == null ? void 0 : ue.defaultToggledOn);
    const K = (De = h.notification) == null ? void 0 : De.sound;
    ...
    if (K != null && K.startsWith("data:audio")) {
      const ne = atob(K.split(",")[1]), Oe = new ArrayBuffer(ne.length), At = new Uint8Array(Oe);
      for (let ut = 0; ut < ne.length; ut++)
        At[ut] = ne.charCodeAt(ut);
      pe = Oe;
    } else
      pe = await (await fetch(K)).arrayBuffer();
    de.current = await _.current.decodeAudioData(pe);
  }, _e = () => {
    H(!0);
    ...
    var ae, pe;
    if (!_.current || k.length === 0)
      return;
    const K = k[k.length - 1];
    if (!(!K || K.sender === "user" || tt || (ae = h.theme) != null && ae.embedded) && !(h.isOpen && !We) && (Ce((ue) => ue + 1), !((pe = h.notification) != null && pe.disabled) && b && re && de.current)) {
      const ue = _.current.createBufferSource();
      ue.buffer = de.current, ue.connect(ee.current).connect(_.current.destination), ue.start();
    }
  }, Ge = () => R.length > 0 ? R[R.length - 1] : null, yt = () => R.length > 1 ? R[R.length - 2] : null, jt = async (K, ae = "bot") => {
    var ve, ne, Oe, At, ut, st;
    const pe = { content: K, sender: ae };
    Bs(h, ce, pe);
    const ue = typeof pe.content == "string" && pe.sender === "bot" && ((ve = h == null ? void 0 : h.botBubble) == null ? void 0 : ve.simStream), De = typeof pe.content == "string" && pe.sender === "user" && ((ne = h == null ? void 0 : h.userBubble) == null ? void 0 : ne.simStream);
    if (ue) {
      const Lt = (Oe = h.botBubble) == null ? void 0 : Oe.streamSpeed, St = (At = h.botBubble) == null ? void 0 : At.dangerouslySetInnerHtml;
      await mt(pe, Lt, St);
    } else if (De) {
      const Lt = (ut = h.userBubble) == null ? void 0 : ut.streamSpeed, St = (st = h.userBubble) == null ? void 0 : st.dangerouslySetInnerHtml;
      await mt(pe, Lt, St);
    } else
      f((Lt) => [...Lt, pe]);
  }, mt = async (K, ae, pe) => {
    rt(!1), f((Oe) => [...Oe, K]), G.current = !0;
    let ue = K.content;
    pe && (ue = os(ue));
    let De = 0;
    const ve = ue.length;
    K.content = "", await new Promise((Oe) => {
      const At = setInterval(() => {
        ...
        f((ut) => {
          ...
          for (let Lt = st.length - 1; Lt >= 0; Lt--)
            if (st[Lt].sender === K.sender && typeof st[Lt].content == "string") {
              K.content += ue[De], st[Lt] = K, De++;
              break;
            }
          return st;
        });
    ...
    const pe = { content: K, sender: ae };
    if (!G.current) {
      rt(!1), f((ue) => [...ue, pe]), G.current = !0;
      return;
    }
    f((ue) => {
      const De = [...ue];
      for (let ve = De.length - 1; ve >= 0; ve--)
        if (De[ve].sender === ae && typeof De[ve].content == typeof K) {
          De[ve] = pe;
          break;
        }
      return De;
    ...
    if (!ae)
      return;
    const pe = ae.chatDisabled ? ae.chatDisabled : (ue = h.chatInput) == null ? void 0 : ue.disabled;
    be(pe), pe || setTimeout(() => {
      var De, ve, ne;
      (De = h.theme) != null && De.embedded ? is(U.current) && ((ve = j.current) == null || ve.focus()) : K !== "start" && ((ne = j.current) == null || ne.focus());
    }, 100), ae.isSensitive ? Ee(ae.isSensitive) : Ee(!1);
  }, Xt = () => {
    $((K) => !K);
  }, Ir = () => {
    he((K) => !K);
    ...
    var ue, De;
    clearTimeout(gt), ae = ae.trim(), E.current = ae, ae !== "" && (pe && await nt(ae), U.current && (U.current.scrollTop = U.current.scrollHeight), j.current && (j.current.value = ""), (ue = h.chatInput) != null && ue.blockSpam && be(!0), P.current = Ae, yu(!1, h), setTimeout(() => {
      rt(!0);
    }, 400), setTimeout(async () => {
      const ve = { prevPath: yt(), userInput: ae, injectMessage: jt, streamMessage: Zt, openChat: ht };
      await Hu(I, K, ve, W) || (Et(), yu(P.current, h), rt(!1));
    }, (De = h.chatInput) == null ? void 0 : De.botDelay));
  }, nt = async (K) => {
    var ue, De, ve;
    const ae = Ge();
    if (!ae)
    ...
    if (pe) {
      if (pe.isSensitive) {
        if ((ue = h == null ? void 0 : h.sensitiveInput) != null && ue.hideInUserBubble)
          return;
        if ((De = h == null ? void 0 : h.sensitiveInput) != null && De.maskInUserBubble) {
          await jt("*".repeat(((ve = h.sensitiveInput) == null ? void 0 : ve.asterisksCount) || 10), "user");
          return;
        }
      }
      await jt(K, "user");
  ...
  return /* @__PURE__ */ F.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ F.jsx(fs, {}),
        /* @__PURE__ */ F.jsx(cs, { unreadCount: je }),
        h.isOpen && !Qr && !((sr = h.theme) != null && sr.embedded) && /* @__PURE__ */ F.jsxs(F.Fragment, { children: [
        ...
        /* @__PURE__ */ F.jsxs(
          "div",
          {
            ...
            children: [
              ((qt = h.theme) == null ? void 0 : qt.showHeader) && /* @__PURE__ */ F.jsx(
                _u,
                {
                  notificationToggledOn: b,
                  handleToggleNotification: Xt,
                  audioToggledOn: ce,
                  handleToggleAudio: Ir
                }
              ),
              /* @__PURE__ */ F.jsx(
                es,
              ...
              ((wr = h.theme) == null ? void 0 : wr.showInputRow) && /* @__PURE__ */ F.jsx(
                as,
                {
                  handleToggleVoice: It,
                  handleActionInput: at,
                  inputRef: j,
                  textAreaDisabled: le,
              ...
              ((lr = h.theme) == null ? void 0 : lr.showFooter) && /* @__PURE__ */ F.jsx(
                ls,
                {
                  inputRef: j,
                  flow: I,
...
const ol = "data:image/svg+xml;base64,", il = "data:audio/wav;base64,", Su = {
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ F.jsxs("span", { style: { fontWeight: "bold" }, children: [
            /* @__PURE__ */ F.jsx("img", { style: { width: 10, height: 10 }, src: Rs }),
  ...
  var h, S;
  return I ? (((h = I.chatInput) == null ? void 0 : h.botDelay) != null && ((S = I.chatInput) == null ? void 0 : S.botDelay) < 500 && (I.chatInput.botDelay = 500), ul(I)) : Su;
}, ul = (I) => {
  const h = { ...Su };
  for (const S in I)
  ...
  var ee;
  const [S, k] = Fe(al(h)), [f, R] = Fe([]), [W, U] = Fe(["start"]), j = I ?? As, E = (re) => /* @__PURE__ */ F.jsx(Bu.Provider, { value: { botOptions: S, setBotOptions: k }, children: re }), G = (re) => /* @__PURE__ */ F.jsx(Yu.Provider, { value: { paths: W, setPaths: U }, children: re }), P = (re) => /* @__PURE__ */ F.jsx(Uu.Provider, { value: { messages: f, setMessages: R }, children: re }), _ = () => {
    var H, b, $;
    let re = /* @__PURE__ */ F.jsx(Us, { flow: j });
    return (H = S.advance) != null && H.useCustomMessages || (re = P(re)), (b = S.advance) != null && b.useCustomPaths || (re = G(re)), ($ = S.advance) != null && $.useCustomBotOptions || (re = E(re)), re;
  }, de = () => {
    var re, H;
    return Qr && ((re = S.theme) == null ? void 0 : re.desktopEnabled) || !Qr && ((H = S.theme) == null ? void 0 : H.mobileEnabled);
  };
  return /* @__PURE__ */ F.jsx(F.Fragment, { children: de() && /* @__PURE__ */ F.jsx("div", { style: { fontFamily: (ee = S.theme) == null ? void 0 : ee.fontFamily }, children: _() }) });
};
export {
